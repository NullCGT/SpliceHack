...
NEARDATA struct permonst mons_init[] = {
    ...
    MON("bullet ant", S_ANT, LVL(4, 18, 3, 0, 0), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_STNG, AD_DRCO, 5, 4), NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(20, 5, MS_ANT, MZ_TINY), MR_POISON, MR_POISON,
        M1_ANIMAL | M1_NOHANDS | M1_OVIPAROUS | M1_POIS | M1_CARNIVORE,
    ...
    MON("thriae", S_ANT, LVL(10, 12, 0, 0, 0), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_STNG, AD_DRST, 2, 6), 
          ATTK(AT_CLAW, AD_SEDU, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 300, MS_BUZZ, MZ_HUMAN), MR_POISON, MR_POISON,
        M1_HUMANOID | M1_POIS | M1_FLY,
        M2_HOSTILE | M2_FEMALE | M2_COLLECT, 0, 0, 14, CLR_BRIGHT_MAGENTA),
    ...
    MON("werecockatrice", S_COCKATRICE, LVL(6, 6, 6, 30, -7), (G_NOGEN | G_NOCORPSE),
        A(ATTK(AT_BITE, AD_WERE, 1, 3), ATTK(AT_TUCH, AD_STON, 0, 0),
          ATTK(AT_NONE, AD_STON, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(30, 30, MS_HISS, MZ_SMALL), MR_POISON | MR_STONE,
        MR_POISON | MR_STONE,
        M1_ANIMAL | M1_NOHANDS | M1_OMNIVORE | M1_OVIPAROUS, M2_HOSTILE,
        M3_INFRAVISIBLE, 0, 9, CLR_YELLOW),
    /*
     * dogs & other canines
     */
    ...
    MON("wolf", S_DOG, LVL(5, 12, 4, 0, 0), (G_GENO | G_SGROUP | 2),
        ...
        M3_INFRAVISIBLE | M3_ORGANIZED, 0, 6, CLR_BROWN),
    ...
    MON("memory hound", S_DOG, LVL(7, 12, 2, 0, 3), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_MEMR, 3, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(250, 200, MS_BARK, MZ_SMALL), MR_COLD, MR_COLD,
        M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISION, 0, 7, CLR_BLUE),
    MON("thought eater", S_DOG, LVL(7, 12, 2, 0, -3), (G_GENO | G_SGROUP | 2),
    ...
    MON("barghest", S_DOG, LVL(7, 12, 4, 20, -7), (G_GENO | 1),
        ...
        9, CLR_BLACK),
    MON("guard dog", S_DOG, LVL(10, 14, 4, 0, 0), (G_GENO | G_NOGEN),
        A(ATTK(AT_BITE, AD_PHYS, 3, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("concussive sphere", S_EYE, LVL(6, 13, 4, 0, 0),
        ...
        M1_FLY | M1_BREATHLESS | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, 0, 0, 8, CLR_BRIGHT_CYAN),
    MON("psionic sphere", S_EYE, LVL(6, 13, 4, 0, 0),
        (G_NOCORPSE | G_GENO | 2), A(ATTK(AT_EXPL, AD_PSYC, 4, 6), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(10, 10, MS_SILENT, MZ_SMALL), MR_PSYCHIC, 0,
        M1_FLY | M1_BREATHLESS | M1_NOLIMBS | M1_NOHEAD | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, 0, 0, 8, CLR_BRIGHT_MAGENTA),
    ...
    MON("sphere of the void", S_EYE, LVL(25, 4, -3, 100, 0), (G_NOCORPSE | 1),
          ...
          M1_FLY | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS | M1_NOTAKE
            | M1_WALLWALK, 
          M2_NOPOLY | M2_NEUTER | M2_NASTY, M3_DISPLACES, 0, 30, HI_LORD),
    /*
     * felines
     */
    ...
    MON("kitten", S_FELINE, LVL(2, 18, 6, 0, 0), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 0, 3, HI_DOMESTIC),
    MON("housecat", S_FELINE, LVL(4, 16, 5, 0, 0), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 0, 5, HI_DOMESTIC),
    MON("jaguar", S_FELINE, LVL(4, 15, 6, 0, 0), (G_GENO | 2),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE,
        M3_INFRAVISIBLE | M3_INFRAVISION, 0, 6, CLR_BROWN),
    MON("lynx", S_FELINE, LVL(5, 15, 6, 0, 0), (G_GENO | 1),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE,
        M3_INFRAVISIBLE | M3_INFRAVISION, 0, 7, CLR_CYAN),
    MON("panther", S_FELINE, LVL(5, 15, 6, 0, 0), (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
          ATTK(AT_BITE, AD_PHYS, 1, 10), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 300, MS_GROWL, MZ_LARGE), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE,
        M3_INFRAVISIBLE | M3_INFRAVISION, 0, 7, CLR_BLACK),
    MON("werecat", S_FELINE, LVL(5, 12, 4, 20, -7), (G_NOGEN | G_NOCORPSE),
        A(ATTK(AT_BITE, AD_WERE, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 2), 
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(500, 250, MS_GROWL, MZ_MEDIUM), MR_POISON, 0,
        M1_NOHANDS | M1_POIS | M1_REGEN | M1_CARNIVORE,
        M2_NOPOLY | M2_HOSTILE, M3_INFRAVISIBLE, MH_WERE,
        7, CLR_BROWN),
    ...
    MON("lion", S_FELINE, LVL(6, 12, 6, 0, 0), (G_GENO | G_SGROUP | 2),
        ...
        M3_INFRAVISIBLE, M3_ORGANIZED, 8, CLR_YELLOW),
    ...
    MON("fat cat", S_FELINE, LVL(10, 14, 3, 0, 0), (G_GENO | G_NOGEN),
        A(ATTK(AT_BITE, AD_PHYS, 3, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(300, 300, MS_MEW, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, 
        M2_STRONG | M2_DOMESTIC | M2_GREEDY,
        M3_INFRAVISIBLE, 0, 10, HI_DOMESTIC),
    MON("displacer beast", S_FELINE, LVL(12, 12, -10, 0, -3), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_DISPLACES, 0, 14, CLR_BLUE),
    MON("hellcat", S_FELINE, LVL(12, 12, 6, 0, 0), (G_HELL | G_GENO | 3),
      	A(ATTK(AT_CLAW, AD_PHYS, 4, 4), ATTK(AT_CLAW, AD_PHYS, 4, 4),
    ...
    MON("dwarf wrestler", S_HUMANOID, LVL(5, 6, 10, 10, 5), (G_GENO | G_NOGEN),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 2), ATTK(AT_WEAP, AD_PHYS, 2, 2), 
          ATTK(AT_HUGS, AD_PHYS, 4, 4), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(900, 300, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_TUNNEL | M1_NEEDPICK | M1_HUMANOID | M1_OMNIVORE,
        M2_STRONG | M2_LORD | M2_MALE | M2_GREEDY | M2_JEWELS | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DWARF, 8, CLR_MAGENTA),
    MON("dwarf royal", S_HUMANOID, LVL(6, 6, 10, 20, 6), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_ORGANIZED, MH_DWARF, 8, HI_LORD),
    ...
    MON("mind flayer telepath", S_HUMANOID, LVL(11, 9, 4, 90, -8),
        (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 4), ATTK(AT_TENT, AD_DRIN, 2, 1),
          ATTK(AT_MAGC, AD_PSYC, 1, 4), NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1450, 400, MS_HISS, MZ_HUMAN), MR_PSYCHIC, 0,
        M1_HUMANOID | M1_FLY | M1_SEE_INVIS | M1_OMNIVORE,
        M2_HOSTILE | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_FLAYER, 16, CLR_MAGENTA),
    MON("vampiric mind flayer", S_HUMANOID, LVL(12, 12, 5, 90, -8), (G_GENO | G_HELL | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 4), ATTK(AT_BITE, AD_DRLI, 1, 8),
          ATTK(AT_TENT, AD_DRIN, 2, 1), ATTK(AT_TENT, AD_DRIN, 2, 1), 
          ATTK(AT_TENT, AD_DRIN, 2, 1), NO_ATTK),
        SIZ(1450, 400, MS_HISS, MZ_HUMAN), 
        MR_PSYCHIC | MR_SLEEP | MR_POISON, 0,
        M1_HUMANOID | M1_FLY | M1_SEE_INVIS | M1_OMNIVORE | M1_BREATHLESS
            | M1_REGEN,
        M2_HOSTILE | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_COLLECT,
        M3_INFRAVISION, MH_FLAYER | MH_VAMPIRE | MH_UNDEAD, 16, CLR_MAGENTA),
    ...
    MON("planar pirate", S_HUMANOID, LVL(15, 16, -7, 0, 0),
        ...
        M3_INFRAVISION, M3_ORGANIZED, 18, CLR_WHITE),
    MON("deeper one", S_HUMANOID, LVL(15, 12, 0, 30, -7),
        ...
        M2_HOSTILE | M2_STALK | M2_GREEDY | M2_JEWELS | M2_COLLECT | M2_LORD
            | M2_STRONG | M2_MAGIC,
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_ORGANIZED, 0, 18, CLR_BRIGHT_GREEN),
    MON("deepest one", S_HUMANOID, LVL(30, 15, -5, 70, -9), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_STALK | M2_GREEDY | M2_JEWELS | M2_COLLECT | M2_PRINCE
            | M2_STRONG | M2_MAGIC,
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_ORGANIZED, 0, 33, HI_LORD),
    /*
    ...
    MON("manes", S_IMP, LVL(1, 3, 7, 0, -7),
        ...
        M2_HOSTILE | M2_STALK, M3_INFRAVISIBLE | M3_INFRAVISION | M3_ORGANIZED, 
        0, 3, CLR_RED),
    ...
    MON("lemure", S_IMP, LVL(3, 3, 7, 0, -7),
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(150, 100, MS_SILENT, MZ_SMALL), MR_SLEEP | MR_POISON, MR_SLEEP,
    ...
    MON("killer mimic", S_MIMIC, LVL(10, 12, 7, 20, 0), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_STCK, 3, 4), ATTK(AT_BITE, AD_STCK, 3, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 400, MS_SILENT, MZ_LARGE), MR_ACID, 0,
        M1_CLING | M1_BREATHLESS | M1_AMORPHOUS | M1_HIDE | M1_ANIMAL
            | M1_NOEYES | M1_NOHEAD | M1_NOLIMBS | M1_THICK_HIDE
            | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG, 0, 0, 13, CLR_GREEN),
    /*
     * nymphs
     */
    ...
    MON("dream thief", S_NYMPH, LVL(14, 15, 4, 40, 0), (G_PLANES | 2),
        A(ATTK(AT_CLAW, AD_CURS, 0, 0), ATTK(AT_CLAW, AD_SITM, 0, 0), 
          ATTK(AT_CLAW, AD_SEDU, 0, 0), ATTK(AT_MAGC, AD_PSYC, 5, 5), 
          NO_ATTK, NO_ATTK),
        SIZ(600, 300, MS_SEDUCE, MZ_HUMAN), 0, 0, 
        M1_HUMANOID | M1_TPORT | M1_FLY,
        M2_HOSTILE | M2_FEMALE | M2_COLLECT, M3_INFRAVISIBLE, 
        0, 18, CLR_BRIGHT_GREEN),
    /*
     * orcs
     */
    ...
    MON("Uruk-hai", S_ORC, LVL(3, 7, 10, 0, -4), (G_GENO | G_LGROUP | 1),
        ...
        M2_STRONG | M2_GREEDY | M2_JEWELS | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_ORGANIZED, MH_ORC, 5, CLR_BLACK),
    ...
    MON("orc-captain", S_ORC, LVL(5, 5, 10, 0, -5), (G_GENO | 1),
        ...
        M2_STRONG | M2_GREEDY | M2_JEWELS | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_ORGANIZED, MH_ORC, 7, HI_LORD),
    MON("orc warlord", S_ORC, LVL(6, 5, 12, 0, -5), (G_GENO | G_NOGEN),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1350, 350, MS_ORC, MZ_HUMAN), 0, 0, M1_HUMANOID | M1_OMNIVORE,
        M2_STRONG | M2_GREEDY | M2_JEWELS | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_ORGANIZED, MH_ORC, 9, HI_LORD),
    /*
     * piercers
     */
    ...
    MON("cow", S_QUADRUPED, LVL(1, 6, 8, 0, 0), (G_GENO | G_SGROUP | 1),
        ...
        M3_INFRAVISIBLE, 0, 2, HI_DOMESTIC),
    ...
    MON("boar", S_QUADRUPED, LVL(2, 12, 7, 0, 0), (G_GENO | 2),
        ...
        M3_INFRAVISIBLE, 0, 4, CLR_BRIGHT_MAGENTA),
    ...
    MON("hippo", S_QUADRUPED, LVL(10, 3, 2, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 3, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(2600, 500, MS_YAWN, MZ_LARGE), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_OMNIVORE | M1_SWIM,
        M2_HOSTILE | M2_STRONG | M2_WANDER, M3_INFRAVISIBLE, 
    ...
    MON("walrus", S_QUADRUPED, LVL(14, 3, -1, 0, 0), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_BITE, AD_PHYS, 5, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1800, 500, MS_BARK, MZ_LARGE), MR_COLD, 0,
    ...
    MON("enormous rat", S_RODENT,
        ...
        A(ATTK(AT_BITE, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(200, 100, MS_SQEEK, MZ_SMALL), 0, 0,
    ...
    MON("rodent of unusual size", S_RODENT,
        ...
        A(ATTK(AT_BITE, AD_PHYS, 2, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(500, 200, MS_SQEEK, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISIBLE,
        0, 8, CLR_BROWN),
    ...
    MON("hellrat", S_RODENT, LVL(5, 15, 7, 0, 0),
        (G_HELL | G_GENO | G_LGROUP | G_NOCORPSE | 3),
    ...
    MON("selkie", S_UNICORN, LVL(11, 24, 4, 0, 0), (G_GENO | 1),
        A(ATTK(AT_KICK, AD_PHYS, 1, 10), ATTK(AT_BITE, AD_DRLI, 2, 6),
          ATTK(AT_TUCH, AD_WRAP, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1800, 350, MS_NEIGH, MZ_LARGE), 0, 0,
        M1_NOHANDS | M1_CARNIVORE | M1_SWIM | M1_AMPHIBIOUS | M1_CONCEAL,
        M2_WANDER | M2_HOSTILE | M2_STRONG, M3_INFRAVISION, 
        0, 13, CLR_GREEN),
    ...
    MON("white horse", S_UNICORN, LVL(18, 24, 0, 70, 0), (G_NOGEN | G_NOCORPSE),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_HERBIVORE | M1_FLY,
        M2_NOPOLY | M2_NASTY | M2_HOSTILE | M2_STRONG,
        M3_INFRAVISIBLE, MH_UNDEAD, 21, CLR_WHITE),
    MON("black horse", S_UNICORN, LVL(18, 24, 0, 70, 0), (G_NOGEN | G_NOCORPSE),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_HERBIVORE | M1_FLY,
        M2_NOPOLY | M2_NASTY | M2_HOSTILE | M2_STRONG,
        M3_INFRAVISIBLE, 0, 21, CLR_BLACK),
    /*
     * vortices
     */
    ...
    MON("vent wurm", S_WORM, LVL(15, 9, 3, 10, 0), (G_GENO | G_PLANES | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 8), ATTK(AT_ENGL, AD_PHYS, 1, 10),
          ATTK(AT_NONE, AD_FIRE, 0, 8), ATTK(AT_BREA, AD_DRST, 1, 2), 
          ATTK(AT_BOOM, AD_FIRE, 3, 4), NO_ATTK),
        SIZ(2000, 600, MS_SILENT, MZ_GIGANTIC), AD_FIRE, AD_FIRE,
        M1_ANIMAL | M1_SLITHY | M1_NOLIMBS | M1_METALLIVORE | M1_TUNNEL
            | M1_THICK_HIDE,
        M2_HOSTILE | M2_STRONG | M2_NASTY, M3_INFRAVISIBLE, 0, 21, CLR_ORANGE),
    MON("crevasse wurm", S_WORM, LVL(15, 9, 3, 10, 0), (G_GENO | G_PLANES | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 8), ATTK(AT_ENGL, AD_PHYS, 1, 10),
          ATTK(AT_NONE, AD_COLD, 0, 8), ATTK(AT_BREA, AD_COLD, 1, 2), 
          ATTK(AT_BOOM, AD_COLD, 3, 4), NO_ATTK),
        SIZ(2000, 600, MS_SILENT, MZ_GIGANTIC), AD_COLD, AD_COLD,
        M1_ANIMAL | M1_SLITHY | M1_NOLIMBS | M1_METALLIVORE | M1_TUNNEL
            | M1_THICK_HIDE,
        M2_HOSTILE | M2_STRONG | M2_NASTY, M3_INFRAVISIBLE, 0, 21, CLR_BRIGHT_CYAN),
    /*
     * xan, &c
     */
    ...
    MON("movanic deva", S_ANGEL, LVL(12, 18, -5, 90, 15), 
        ...
        M2_NOPOLY | M2_MINION | M2_STALK | M2_STRONG | M2_NASTY,
	      M3_INFRAVISIBLE | M3_INFRAVISION, MH_ANGEL, 21, CLR_BLUE),
    MON("monadic deva", S_ANGEL, LVL(15, 18, -4, 90, 15), 
        (G_PLANES | G_NOCORPSE | 1),
      	...
      	M1_FLY | M1_HUMANOID | M1_SEE_INVIS,
      	M2_NOPOLY | M2_MINION | M2_STALK | M2_STRONG | M2_NASTY, 
	      M3_INFRAVISIBLE | M3_INFRAVISION, MH_ANGEL, 23, CLR_BRIGHT_CYAN),
    MON("astral deva", S_ANGEL, LVL(18, 18, -6, 90, 15), 
        (G_PLANES | G_NOCORPSE | 1),
        ...
        M1_FLY | M1_HUMANOID | M1_SEE_INVIS,
        M2_NOPOLY | M2_MINION | M2_STALK | M2_STRONG | M2_NASTY, 
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_ANGEL, 27, CLR_WHITE),
    ...
    MON("Avatar of Akasha", S_ANGEL, LVL(16, 18, -4, 55, 0),
        (G_NOHELL | G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6),
        ...
        M2_NOPOLY | M2_MINION | M2_STALK | M2_STRONG | M2_NASTY | M2_COLLECT |
        M2_MAGIC,
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_ANGEL, 21, CLR_WHITE),
    ...
    MON("Herald Archon", S_ANGEL, LVL(16, 16, -6, 50, 15),
        ...
        M2_NOPOLY | M2_MINION | M2_STALK | M2_STRONG | M2_NASTY
            | M2_COLLECT | M2_MAGIC,
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_ORGANIZED, MH_ANGEL, 20, CLR_CYAN),
    ...
    MON("Planetar", S_ANGEL, LVL(29, 16, -10, 80, 15), 
        ...
        M2_NOPOLY | M2_MINION | M2_STALK | M2_STRONG | M2_NASTY | M2_LORD | 
        M2_COLLECT | M2_MAGIC, M3_INFRAVISIBLE | M3_INFRAVISION, MH_ANGEL, 
        38, CLR_CYAN),
    MON("Solar", S_ANGEL, LVL(39, 16, -10, 80, 15), 
        (G_PLANES | G_NOCORPSE | 1),
        ...
        M2_COLLECT | M2_MAGIC, M3_INFRAVISIBLE | M3_INFRAVISION, MH_ANGEL, 
        49, CLR_BROWN),
    MON("Lawful Deific Avatar", S_ANGEL, LVL(50, 18, -15, 100, 30),
        (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 10, 4), ATTK(AT_WEAP, AD_PHYS, 10, 4),
          ATTK(AT_GAZE, AD_BLND, 10, 6), ATTK(AT_MAGC, AD_CLRC, 8, 6), 
          NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_LARGE),
        MR_FIRE | MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON | MR_STONE | MR_PSYCHIC | MR_SONIC,
        MR_FIRE | MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON | MR_STONE,
        M1_FLY | M1_HUMANOID | M1_SEE_INVIS | M1_REGEN | M1_TPORT_CNTRL | M1_TPORT,
        M2_NOPOLY | M2_STALK | M2_STRONG | M2_NASTY | M2_LORD | M2_COLLECT 
          | M2_MAGIC | M2_STRONG | M2_ROCKTHROW | M2_PNAME,
        M3_INFRAVISION | M3_INFRAVISIBLE | M3_WANTSAMUL, 0, 80, HI_LORD),
    MON("Neutral Deific Avatar", S_ANGEL, LVL(50, 18, -15, 100, 0),
        (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 10, 4), ATTK(AT_WEAP, AD_PHYS, 10, 4),
          ATTK(AT_GAZE, AD_STUN, 10, 6), ATTK(AT_MAGC, AD_CLRC, 8, 6), 
          NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_LARGE),
        MR_FIRE | MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON | MR_STONE | MR_PSYCHIC | MR_SONIC,
        MR_FIRE | MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON | MR_STONE,
        M1_FLY | M1_HUMANOID | M1_SEE_INVIS | M1_REGEN | M1_TPORT_CNTRL | M1_TPORT | M1_BREATHLESS,
        M2_NOPOLY | M2_STALK | M2_STRONG | M2_NASTY | M2_LORD | M2_COLLECT 
          | M2_MAGIC | M2_STRONG | M2_ROCKTHROW | M2_PNAME,
        M3_INFRAVISION | M3_INFRAVISIBLE | M3_WANTSAMUL, 0, 80, HI_LORD),
    MON("Chaotic Deific Avatar", S_ANGEL, LVL(50, 18, -15, 100, 30),
        (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 10, 4), ATTK(AT_WEAP, AD_PHYS, 10, 4),
          ATTK(AT_GAZE, AD_CONF, 10, 6), ATTK(AT_MAGC, AD_CLRC, 8, 6), 
          NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_LARGE),
        MR_FIRE | MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON | MR_STONE | MR_PSYCHIC | MR_SONIC,
        MR_FIRE | MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON | MR_STONE,
    ...
    MON("baby penguin", S_BAT, LVL(2, 18, 6, 0, 0), (G_GENO | G_NOGEN),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(150, 150, MS_SQAWK, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE | M1_OVIPAROUS, M2_DOMESTIC,
        M3_INFRAVISIBLE, 0, 3, HI_DOMESTIC),
    ...
    MON("penguin", S_BAT, LVL(4, 16, 5, 0, 0), (G_GENO | G_NOGEN),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(200, 200, MS_SQAWK, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE | M1_OVIPAROUS, M2_DOMESTIC,
    ...
    MON("hellbat", S_BAT, LVL(7, 22, 7, 0, 0),
      (G_HELL | G_GENO | G_SGROUP | G_NOCORPSE | 2),
    ...
    MON("emperor penguin", S_BAT, LVL(6, 15, 4, 0, 0), (G_GENO | G_NOGEN),
        A(ATTK(AT_BITE, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(250, 250, MS_SQAWK, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE | M1_OVIPAROUS, M2_STRONG | M2_DOMESTIC,
        M3_INFRAVISIBLE, 0, 7, HI_DOMESTIC),
    MON("tuxedo penguin", S_BAT, LVL(10, 14, 4, 0, 0), (G_GENO | G_NOGEN),
        A(ATTK(AT_BITE, AD_PHYS, 3, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(300, 250, MS_SQAWK, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE | M1_OVIPAROUS, M2_STRONG | M2_DOMESTIC,
        M3_INFRAVISIBLE, 0, 7, HI_DOMESTIC),
    ...
    MON("armanite", S_CENTAUR, LVL(9, 20, 2, 10, -3), 
        (G_GENO | G_SGROUP | G_HELL | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 8), ATTK(AT_KICK, AD_PHYS, 2, 6),
          ATTK(AT_KICK, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2550, 500, MS_HUMANOID, MZ_LARGE), MR_FIRE | MR_POISON, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_STRONG | M2_GREEDY | M2_COLLECT,
        M3_INFRAVISIBLE, MH_DEMON, 16, CLR_RED),
    /*
     * Dragons
     */
   ...
   MON("fell beast", S_DRAGON, LVL(14, 12, -2, 20, -17), G_NOGEN,
    ...
    MON("magma elemental", S_ELEMENTAL, LVL(8, 6, 2, 30, 0), (G_NOCORPSE | G_HELL),
    ...
    MON("ice elemental", S_ELEMENTAL, LVL(8, 12, 2, 30, 0), (G_NOCORPSE | G_NOGEN),
        A(ATTK(AT_CLAW, AD_PHYS, 5, 6), ATTK(AT_NONE, AD_COLD, 0, 4), 
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2500, 0, MS_SILENT, MZ_LARGE), MR_POISON | MR_STONE | MR_COLD, 0,
        M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS | M1_BREATHLESS
            | M1_UNSOLID | M1_AMPHIBIOUS | M1_SWIM,
    ...
    MON("fusion elemental", S_ELEMENTAL, LVL(25, 18, 2, 30, 0),
        ...
        A(ATTK(AT_CLAW, AD_FIRE, 2, 6), ATTK(AT_CLAW, AD_PHYS, 2, 6),
          ...
          NO_ATTK, NO_ATTK),
        SIZ(3000, 0, MS_SILENT, MZ_GIGANTIC), MR_POISON | MR_STONE | MR_FIRE, 0,
        M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS | M1_BREATHLESS
    ...
    MON("myconid scout", S_FUNGUS, LVL(3, 12, 7, 0, 0), (G_GENO | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_TUCH, AD_STCK, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(100, 100, MS_SILENT, MZ_SMALL), MR_POISON, MR_POISON,
    ...
    MON("myconid warrior", S_FUNGUS, LVL(5, 12, 7, 0, 0), (G_GENO | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_TUCH, AD_STCK, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 200, MS_SILENT, MZ_MEDIUM), MR_POISON, MR_POISON,
        M1_BREATHLESS | M1_NOHEAD | M1_POIS,
    ...
    MON("myconid reaver", S_FUNGUS, LVL(7, 15, 7, 0, 0), (G_GENO | 1),
    ...
    MON("gnoll chieftain", S_GNOLL,
      	...
      	M1_HIDE | M1_HUMANOID | M1_POIS | M1_SEE_INVIS | M1_OMNIVORE,
      	M2_NOPOLY | M2_HOSTILE | M2_COLLECT | M2_MAGIC | M2_GREEDY | M2_JEWELS,
      	M3_INFRAVISION | M3_ORGANIZED, 0, 33, CLR_MAGENTA),
    ...
    MON("marrashi", S_GNOLL,
      	...
      	M2_NOPOLY | M2_HOSTILE | M2_COLLECT | M2_MAGIC | M2_GREEDY | M2_JEWELS,
      	M3_INFRAVISION, 0, 26, CLR_YELLOW),
#ifdef SPLITMON_1
};
#endif
#endif /* !SPLITMON_2 */
...
struct permonst _mons2[] = {
    ...
    MON("fire giant", S_GIANT, LVL(9, 12, 4, 5, 2), (G_GENO | G_SGROUP | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_ORGANIZED, MH_GIANT, 11, CLR_YELLOW),
    MON("frost giant", S_GIANT, LVL(10, 12, 3, 10, -3),
        ...
        M1_HUMANOID | M1_CARNIVORE, M2_STRONG | M2_ROCKTHROW
                                        | M2_NASTY | M2_COLLECT | M2_JEWELS,
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_ORGANIZED, MH_GIANT, 13, CLR_WHITE),
    ...
    MON("storm giant", S_GIANT, LVL(16, 12, 3, 10, -3),
        ...
        M1_HUMANOID | M1_CARNIVORE, M2_STRONG | M2_ROCKTHROW
                                        | M2_NASTY | M2_COLLECT | M2_JEWELS,
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_ORGANIZED, MH_GIANT, 19, CLR_BLUE),
    ...
    MON("Kop Kaptain", S_KOP, LVL(4, 12, 10, 20, 12), (G_GENO | G_NOGEN),
        ...
        SIZ(WT_HUMAN, 200, MS_ARREST, MZ_HUMAN), 0, 0, M1_HUMANOID,
        M2_WANDER | M2_HOSTILE | M2_STRONG | M2_MALE | M2_COLLECT,
        M3_INFRAVISIBLE | M3_ORGANIZED, MH_HUMAN, 6, HI_LORD),
    /*
     * Liches
     */
    ...
    MON("lawyer", S_LICH, LVL(11, 15, 0, 20, 5), (G_GENO | 1),
    ...
    MON("red naga hatchling", S_NAGA, LVL(3, 10, 6, 0, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(500, 100, MS_MUMBLE, MZ_SMALL), MR_FIRE | MR_POISON,
        MR_FIRE | MR_POISON,
    ...
    MON("black naga hatchling", S_NAGA, LVL(3, 10, 6, 0, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(500, 100, MS_MUMBLE, MZ_SMALL), MR_POISON | MR_ACID | MR_STONE,
    ...
    MON("golden naga hatchling", S_NAGA, LVL(3, 10, 6, 0, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(500, 100, MS_MUMBLE, MZ_SMALL), MR_POISON, MR_POISON,
        M1_NOLIMBS | M1_SLITHY | M1_THICK_HIDE | M1_NOTAKE | M1_OMNIVORE,
    ...
    MON("ogre mage", S_OGRE, LVL(7, 12, 3, 30, -5), (G_NOHELL | G_GENO | 2),
    	...
    	SIZ(1700, 700, MS_GRUNT, MZ_LARGE), 0, 0, M1_HUMANOID | M1_CARNIVORE,
    	M2_STRONG | M2_LORD | M2_GREEDY | M2_JEWELS | M2_COLLECT,
    	M3_INFRAVISIBLE | M3_INFRAVISION | M3_ORGANIZED, 0, 10, HI_ZAP),
    ...
    MON("wandering cactus", S_PLANT, LVL(3, 3, 2, 40, 0),
        ...
        M1_BREATHLESS | M1_HUMANOID | M1_THICK_HIDE | M1_MINDLESS,
        M2_WANDER, 0, 0, 5, CLR_YELLOW),
    ...
    MON("amalgamation", S_QUANTMECH, LVL(10, 7, 5, 10, 0),
        (G_GENO | G_NOCORPSE | 1),
    ...
    MON("genetic engineer", S_QUANTMECH, LVL(12, 12, 3, 10, 0), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE, 0, 14, CLR_GREEN),
    MON("bad clone", S_QUANTMECH, LVL(20, 12, -5, 50, 0),
         (G_GENO | G_NOCORPSE | 1),
         A(ATTK(AT_WEAP, AD_PHYS, 3, 8), ATTK(AT_CLAW, AD_PHYS, 3, 8),
          ATTK(AT_TENT, AD_PHYS, 1, 2), ATTK(AT_TENT, AD_PHYS, 1, 2), 
          ATTK(AT_TENT, AD_PHYS, 1, 2), NO_ATTK),
    ...
    MON("cobra", S_SNAKE, LVL(6, 18, 2, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_DRST, 2, 4), ATTK(AT_SPIT, AD_BLND, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(250, 100, MS_HISS, MZ_LARGE), MR_POISON, MR_POISON,
        M1_SWIM | M1_CONCEAL | M1_NOLIMBS | M1_ANIMAL | M1_SLITHY | M1_POIS
            | M1_CARNIVORE | M1_OVIPAROUS | M1_NOTAKE,
     ...
     */
     MON("baobhan-sith", S_VAMPIRE, LVL(10, 12, 1, 25, -8),
         ...
         M2_FEMALE,
         M3_INFRAVISIBLE, MH_VAMPIRE | MH_UNDEAD, 10, CLR_GREEN),
    MON("vampire", S_VAMPIRE, LVL(10, 12, 1, 25, -8),
        ...
        M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY
            | M2_SHAPESHIFTER,
        M3_INFRAVISIBLE, MH_VAMPIRE | MH_UNDEAD, 12, CLR_RED),
    MON("vampire noble", S_VAMPIRE, LVL(12, 14, 0, 50, -9),
        ...
        M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY | M2_LORD
            | M2_SHAPESHIFTER,
        M3_INFRAVISIBLE, MH_VAMPIRE | MH_UNDEAD, 14, CLR_BLUE),
    ...
    MON("Vlad the Impaler", S_VAMPIRE, LVL(28, 26, -6, 80, -10),
        ...
        M2_NOPOLY | M2_STALK | M2_HOSTILE | M2_PNAME | M2_STRONG
            | M2_NASTY | M2_PRINCE | M2_MALE | M2_SHAPESHIFTER,
        M3_WAITFORU | M3_WANTSCAND | M3_INFRAVISIBLE, MH_VAMPIRE | MH_UNDEAD, 
        32, HI_LORD),
    /*
     * Wraiths
     */
    ...
    MON("ape", S_YETI, LVL(4, 12, 6, 0, 0), (G_GENO | G_SGROUP | 2),
        ...
        M1_ANIMAL | M1_HUMANOID | M1_OMNIVORE, M2_STRONG, 
        M3_INFRAVISIBLE | M3_ORGANIZED, 0,
        6, CLR_BROWN),
    ...
    MON("draugr", S_ZOMBIE, LVL(5, 6, 8, 0, -3),
        ...
        M1_BREATHLESS | M1_HUMANOID,
        M2_STALK | M2_HOSTILE, 
        M3_INFRAVISION | M3_ORGANIZED, MH_UNDEAD, 7, CLR_BLUE),
    ...
    MON("giant zombie", S_ZOMBIE, LVL(8, 8, 6, 0, -4),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 8), ATTK(AT_CLAW, AD_CLOB, 2, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("sludge golem", S_GOLEM, LVL(15, 7, 3, 50, 0), (G_NOCORPSE | 1),
        ...
        SIZ(2000, 0, MS_SILENT, MZ_LARGE), MR_SLEEP | MR_POISON | MR_ACID, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE,
    ...
    MON("miner", S_HUMAN,
        ...
        M1_TUNNEL | M1_NEEDPICK | M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG,
        M3_INFRAVISIBLE, MH_HUMAN, 4, CLR_GRAY),
    MON("prison guard", S_HUMAN,
        ...
        M3_INFRAVISIBLE | M3_ORGANIZED, MH_HUMAN, 14, HI_METAL),
    ...
    /* Werecats are defined only for players */
    MON("werecat", S_HUMAN, LVL(5, 12, 10, 20, -7), (G_NOGEN),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_WERE, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_POIS | M1_OMNIVORE,
    ...
    MON("martial master", S_HUMAN, LVL(9, 12, 2, 20, 0), (2),
        ...
        12, CLR_YELLOW),
    MON("changeling", S_HUMAN, LVL(8, 12, 10, 0, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("elf", S_HUMAN, LVL(10, 12, 10, 2, -3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("elf-lord", S_HUMAN, LVL(8, 12, 10, 20, -9), (G_GENO | G_SGROUP | 2),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_ORGANIZED, MH_ELF, 11, CLR_BRIGHT_BLUE),
    ...
    MON("Elvenking", S_HUMAN, LVL(9, 12, 10, 25, -10), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_ORGANIZED, MH_ELF, 11, HI_LORD),
    ...
    MON("shopkeeper", S_HUMAN, LVL(12, 18, 0, 50, 0), G_NOGEN,
        ...
        M3_INFRAVISIBLE | M3_ORGANIZED, MH_HUMAN, 15, HI_DOMESTIC),
    ...
    MON("Arms Dealer", S_HUMAN, LVL(25, 24, -8, 50, -2), (G_NOGEN | G_UNIQ),
        ...
        MR_FIRE | MR_COLD | MR_POISON | MR_SLEEP | MR_ELEC | MR_STONE,
      	...
      	M2_PNAME | M2_FEMALE,
      	M3_INFRAVISIBLE | M3_ORGANIZED, MH_HUMAN, 28, HI_LORD),
    MON("extraplanar merchant", S_HUMAN, LVL(20, 18, 0, 50, 0), G_NOGEN,
    ...
    MON("guard", S_HUMAN, LVL(12, 12, 10, 40, 10), G_NOGEN,
        ...
        M3_INFRAVISIBLE | M3_ORGANIZED, MH_HUMAN, 14, CLR_BLUE),
    ...
    MON("watchman", S_HUMAN, LVL(6, 10, 10, 0, -2),
        ...
        M3_INFRAVISIBLE | M3_ORGANIZED, MH_HUMAN, 8, CLR_GRAY),
    ...
    MON("Medusa", S_HUMAN, LVL(20, 12, 2, 50, -15), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 1, 8),
          ...
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HISS, MZ_HUMAN), MR_POISON | MR_STONE,
    ...
    MON("Wizard of Yendor", S_HUMAN, LVL(30, 12, -8, 100, A_NONE),
        ...
        A(ATTK(AT_CLAW, AD_SAMU, 2, 12), ATTK(AT_MAGC, AD_SPEL, 0, 0),
          ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("Croesus", S_HUMAN, LVL(20, 15, 0, 40, 15), (G_UNIQ | G_NOGEN),
        ...
        M2_NOPOLY | M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY
            ...
            | M2_COLLECT | M2_MAGIC,
        M3_INFRAVISIBLE | M3_ORGANIZED,  MH_HUMAN, 22, HI_LORD),
#ifdef CHARON
    ...
    MON("lava demon", S_DEMON, LVL(12, 12, -8, 40, -7), 
        ...
        M1_HUMANOID | M1_POIS,
        M2_NOPOLY | M2_STALK | M2_HOSTILE | M2_NASTY | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DEMON, 15, CLR_RED),
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("infernal", S_DEMON, LVL(0, 12, 10, 0, 0), G_NOGEN, /* for corpses */
        ...
        2, HI_DOMESTIC),
    MON("aspect of Zuggotomoy", S_DEMON, LVL(5, 12, -4, 30, -15),
        (G_HELL | G_NOCORPSE | G_NOGEN),
        A(ATTK(AT_CLAW, AD_DRDX, 1, 6), ATTK(AT_CLAW, AD_DRDX, 1, 6),
          ATTK(AT_NONE, AD_RBRE, 1, 6), NO_ATTK, 
          NO_ATTK, NO_ATTK),
        SIZ(800, 100, MS_HISS, MZ_MEDIUM), MR_POISON | MR_ACID, 0,
        M1_AMPHIBIOUS | M1_AMORPHOUS | M1_SEE_INVIS | M1_ACID | M1_POIS
           | M1_HUMANOID,
        M2_STALK | M2_HOSTILE | M2_FEMALE,
        M3_INFRAVISION, MH_DEMON, 7, HI_LORD),
    ...
    MON("barbed devil", S_DEMON, LVL(8, 12, 0, 35, 8),
        (G_HELL | G_NOCORPSE | G_SGROUP | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 3), ATTK(AT_CLAW, AD_PHYS, 2, 3),
          ATTK(AT_STNG, AD_PHYS, 3, 4), ATTK(AT_NONE, AD_QUIL, 5, 4),
          NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_HUMAN), MR_FIRE | MR_POISON, 0,
        M1_POIS | M1_THICK_HIDE, M2_STALK | M2_HOSTILE | M2_NASTY,
    ...
    MON("bar-lgura", S_DEMON, 
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), ATTK(AT_CLAW, AD_PHYS, 1, 6),
          ATTK(AT_BITE, AD_KDNP, 2, 12), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_LARGE),
        MR_FIRE | MR_POISON, 0, M1_POIS,
        M2_STALK | M2_HOSTILE | M2_NASTY,
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DEMON, 10, CLR_ORANGE),
    ...
    MON("ice devil", S_DEMON, LVL(11, 6, -4, 55, -12),
        (G_HELL | G_NOCORPSE | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
          ATTK(AT_BITE, AD_PHYS, 2, 4), ATTK(AT_STNG, AD_FUMB, 3, 4), NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_LARGE),
    ...
    MON("pit fiend", S_DEMON, LVL(13, 6, -3, 65, -13),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_ORGANIZED, MH_DEMON, 16, CLR_ORANGE),
    ...
    MON("balrog", S_DEMON, LVL(16, 5, -2, 75, -14), (G_HELL | G_NOCORPSE | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_ORGANIZED, 
        MH_DEMON, 20, CLR_RED),
    ...
    MON("Juiblex", S_DEMON, LVL(50, 3, -17, 65, -15),
        ...
        26, CLR_BRIGHT_GREEN),
    MON("Zuggotomoy", S_DEMON, LVL(51, 5, -14, 65, -15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        A(ATTK(AT_CLAW, AD_DRDX, 2, 6), ATTK(AT_CLAW, AD_DRDX, 2, 6),
          ATTK(AT_TENT, AD_PHYS, 2, 6), ATTK(AT_NONE, AD_RBRE, 3, 4),
          NO_ATTK, NO_ATTK),
        SIZ(1500, 100, MS_HISS, MZ_HUGE), MR_POISON | MR_ACID, 0,
        M1_AMPHIBIOUS | M1_AMORPHOUS | M1_SEE_INVIS | M1_ACID | M1_POIS
           | M1_HUMANOID,
        M2_NOPOLY | M2_STALK | M2_HOSTILE | M2_PNAME | M2_NASTY
            | M2_LORD | M2_FEMALE,
        M3_WANTSAMUL | M3_INFRAVISION, MH_DEMON, 27, HI_LORD),
    ...
    MON("djinni", S_DEMON, LVL(7, 12, 4, 30, 0), (G_NOGEN | G_NOCORPSE),
        ...
        M3_INFRAVISIBLE, 0, 8, CLR_YELLOW),
    MON("marid", S_DEMON, LVL(14, 15, -5, 75, 0), (G_NOCORPSE | G_NOPLANES | G_GENO | 1),
    ...
    MON("efreet", S_DEMON, LVL(15, 15, 4, 42, 0), (G_PLANES | G_NOCORPSE),
    ...
    MON("Wrath", S_SIN, LVL(77, 18, -7, 80, 0), (G_UNIQ | G_NOGEN),
        ...
        M3_INFRAVISION | M3_ORGANIZED, MH_ANGEL, 77, CLR_MAGENTA),
    MON("Sloth", S_SIN, LVL(77, 10, -7, 100, 0), (G_UNIQ | G_NOGEN),
        ...
        SIZ(1500, 0, MS_GROAN, MZ_GIGANTIC),
        MR_FIRE | MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON | MR_STONE |
        MR_PSYCHIC | MR_SONIC, 0,
    ...
    MON("Pride", S_SIN, LVL(77, 15, -7, 70, 0), (G_UNIQ | G_NOCORPSE | G_NOGEN),
        ...
        MR_PSYCHIC | MR_SONIC, 0,
        M1_FLY | M1_SWIM | M1_REGEN | M1_SEE_INVIS | M1_CARNIVORE 
          | M1_BREATHLESS | M1_UNSOLID | M1_WALLWALK, 
        M2_LORD | M2_NEUTER | M2_HOSTILE | M2_STALK | M2_STRONG
          | M2_PNAME | M2_NOPOLY | M2_NASTY,
        M3_INFRAVISION, 0, 77, CLR_MAGENTA),
    MON("Greed", S_SIN, LVL(77, 13, -7, 80, 0), (G_UNIQ | G_NOGEN),
        A(ATTK(AT_WEAP, AD_PHYS, 8, 8), ATTK(AT_CLAW, AD_DREN, 4, 4),
          ATTK(AT_CLAW, AD_SITM, 2, 4), ATTK(AT_CLAW, AD_SGLD, 2, 4),
          NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SIN, MZ_LARGE), 
        MR_POISON | MR_FIRE | MR_COLD | MR_ELEC | MR_STONE,
        MR_POISON | MR_FIRE | MR_COLD | MR_ELEC,
        M1_FLY | M1_SWIM | M1_HUMANOID | M1_REGEN | M1_SEE_INVIS
          | M1_OMNIVORE | M1_THICK_HIDE | M1_TPORT | M1_TPORT_CNTRL, 
    ...
    MON("Gluttony", S_SIN, LVL(77, 15, -7, 100, 0), (G_UNIQ | G_NOGEN),
        ...
        M2_LORD | M2_NEUTER | M2_HOSTILE | M2_STALK | M2_STRONG
          | M2_PNAME | M2_NOPOLY | M2_NASTY,
        M3_INFRAVISION, 0, 77, CLR_MAGENTA),
    MON("Lust", S_SIN, LVL(77, 18, -7, 80, 0), (G_UNIQ | G_NOGEN),
    ...
    MON("T-Rex", S_LIZARD, LVL(15, 15, 5, 0, 0), (G_GENO | 1),
        ...
        M2_STRONG | M2_HOSTILE, M3_INFRAVISIBLE, 0, 18, CLR_RED),
    ...
    MON("caveperson", S_HUMAN, LVL(10, 12, 10, 0, 1), G_NOGEN,
        ...
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_NEUTER | M2_COLLECT, M3_INFRAVISIBLE, 
        MH_HUMAN, 12, HI_DOMESTIC),
    MON("convict", S_HUMAN,	LVL(10, 12, 10, 1, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        ...
        MH_HUMAN, 12, HI_DOMESTIC),
    MON("dancer", S_HUMAN, LVL(10, 15, 10, 2, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_SAMU, 1, 8), ATTK(AT_WEAP, AD_SAMU, 1, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_COLLECT | M2_FEMALE,
        M3_INFRAVISIBLE, MH_HUMAN, 12, HI_DOMESTIC),
    ...
    MON("priest", S_HUMAN, LVL(10, 12, 10, 2, 0), G_NOGEN,
        ...
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_MALE | M2_COLLECT, M3_INFRAVISIBLE, 
        MH_HUMAN, 12, HI_DOMESTIC),
    ...
    MON("Robert the Lifer", S_HUMAN,
        ...
        M2_NOPOLY | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE | 
          M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, MH_HUMAN, 23, HI_DOMESTIC),
    MON("Troupe Leader", S_HUMAN, LVL(20, 12, 0, 40, 20), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 6), ATTK(AT_WEAP, AD_DSRM, 3, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_LEADER, MZ_HUMAN), MR_FIRE | MR_COLD, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("Warden Arianna", S_HUMAN, LVL(20, 12, 0, 40, -14),
        ...
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISIBLE, MH_HUMAN, 25, HI_LORD),
    MON("Time Elemental", S_ELEMENTAL, LVL(18, 16, 2, 30, 0),
        (G_NOGEN | G_NOCORPSE | G_UNIQ),
        A(ATTK(AT_WEAP, AD_SLOW, 4, 6), ATTK(AT_WEAP, AD_SLOW, 4, 6),
          ATTK(AT_CLAW, AD_LOUD, 1, 6), ATTK(AT_CLAW, AD_PSYC, 1, 6),
          ATTK(AT_CLAW, AD_FIRE, 1, 6), ATTK(AT_CLAW, AD_COLD, 1, 6)),
        SIZ(2500, 0, MS_SILENT, MZ_GIGANTIC), 
        MR_POISON | MR_STONE | MR_FIRE | MR_COLD | MR_SONIC, 0,
        M1_NOEYES | M1_NOHEAD | M1_BREATHLESS
            | M1_UNSOLID | M1_FLY | M1_WALLWALK,
        M2_STRONG | M2_NEUTER | M2_HOSTILE | M2_NASTY, 
        M3_WANTSARTI | M3_WAITFORU, 0, 27, CLR_MAGENTA),
    ...
    MON("backup dancer", S_HUMAN, LVL(5, 15, 10, 2, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 4), ATTK(AT_WEAP, AD_PHYS, 1, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_COLLECT,
    ...
    MON("inmate", S_HUMAN, LVL(12, 12, 10, 0, 0), G_NOGEN,
        ...
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE | M3_CLOSE, MH_HUMAN, 14, CLR_BLACK),
