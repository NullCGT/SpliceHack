...
void NetHackQtStatusWindow::resizeEvent(QResizeEvent*)
{
    ...
    wither.setGeometry(x,y,iw,lh); x+=iw;
...
void NetHackQtStatusWindow::updateStats()
{
    ...
    if (Withering) wither.show(); else wither.hide();
    if (Blind) {
