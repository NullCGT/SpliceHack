...
static XtResource resources[] = {
    ...
    { nhStr("riding_mark_color"), nhStr("Riding_mark_color"), XtRPixel,
      ...
      nhStr("Green") },
     { nhStr("template_mark_bitmap"), nhStr("Template_mark_bitmap"), XtRString,
      sizeof(String), XtOffset(AppResources *, template_mark_bitmap), XtRString,
      nhStr("template_mark.xbm") },
    { nhStr("template_mark_color"), nhStr("Template_mark_color"), XtRPixel,
      sizeof(XtRPixel), XtOffset(AppResources *, template_mark_color), XtRString,
      nhStr("Magenta") },
