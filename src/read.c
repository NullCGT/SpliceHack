...
seffect_enchant_armor(struct obj **sobjp)
{
    ...
    boolean old_erodeproof, new_erodeproof, hypermagical;
...
static void
seffect_elementalism(struct obj **sobjp)
{
...
static void
seffect_change_material(struct obj **sobjp)
{
    struct obj *sobj = *sobjp;
    struct obj *otmp;
    boolean sblessed = sobj->blessed;
