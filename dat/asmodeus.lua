...
des.region({region={25,02,29,05},lit=0,"lemurepit",prefilled=0})
des.region({region={31,03,35,05},lit=0,"lemurepit",prefilled=0})
des.region({region={37,04,41,05},lit=0,"lemurepit",prefilled=0})
des.region({region={37,07,41,08},lit=0,"lemurepit",prefilled=0})
des.region({region={31,07,35,09},lit=0,"lemurepit",prefilled=0})
des.region({region={25,07,29,10},lit=0,"lemurepit",prefilled=0})
