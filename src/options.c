...
int
optfn_birdname(optidx, req, negated, opts, op)
int optidx UNUSED;
int req;
boolean negated UNUSED;
char *opts;
...
int
optfn_orientation(optidx, req, negated, opts, op)
int optidx, req;
boolean negated;
char *opts;
char *op;
...
int
optfn_dragonname(optidx, req, negated, opts, op)
int optidx, req;
boolean negated UNUSED;
char *opts;
char *op;
...
int
optfn_ratname(optidx, req, negated, opts, op)
int optidx, req;
boolean negated UNUSED;
char *opts;
char *op;
    ...
    if (req == get_val) {
        ...
        Sprintf(opts, "%s", (g.preferred_pet == 'c') ? "cat"
                           : (g.preferred_pet == 'd') ? "dog"
                            : (g.preferred_pet == 'b') ? "bird"
                             : (g.preferred_pet == 'h') ? "horse"
                              : (g.preferred_pet == 'r') ? "rat"
                               : (g.preferred_pet == 'D') ? "dragon"
