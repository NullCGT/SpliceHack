...
/* P:pfx, ln, opt_*, setwhere?, negateok?, valok?, dupok?, hndlr? Alias, desc*/
    ...
    NHOPTC(birdname, PL_PSIZ, opt_in, set_gameview, No, Yes, No, No, NoAlias,
                "the name of your (first) bird (e.g., birdname:Polly)")
    ...
    NHOPTC(dragonname, PL_PSIZ, opt_in, set_gameview, No, Yes, No, No, NoAlias,
                "the name of your (first) dragon (e.g., dragonname:Flame)")
    ...
    NHOPTB(ignintr, 0, opt_in, set_in_config, Off, Yes, No, No, NoAlias,
                (boolean *) 0)
#endif
    NHOPTB(illfated, 0, opt_in, set_in_config, Off, Yes, No, No, NoAlias,
                &u.uroleplay.illfated)
