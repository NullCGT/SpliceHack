...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("Time Elemental", S_ELEMENTAL, LVL(18, 16, 2, 30, 0),
        (G_NOGEN | G_NOCORPSE | G_UNIQ),
        A(ATTK(AT_CLAW, AD_SLOW, 4, 6), ATTK(AT_CLAW, AD_SLOW, 4, 6),
          ATTK(AT_CLAW, AD_LOUD, 2, 6), ATTK(AT_CLAW, AD_PSYC, 2, 6),
          ATTK(AT_CLAW, AD_FIRE, 2, 6), ATTK(AT_CLAW, AD_COLD, 2, 6)),
        SIZ(2500, 0, MS_SILENT, MZ_GIGANTIC), 
        MR_POISON | MR_STONE | MR_FIRE | MR_COLD | MR_SONIC, 0,
        M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_BREATHLESS
