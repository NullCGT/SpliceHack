...
NEARDATA struct permonst mons[] = {
    ...
    MON("brood wasp", S_ANT, LVL(8, 18, -1, 0, 0), (G_GENO | 2),
        ...
        M2_HOSTILE | M2_NASTY | M2_FEMALE, 0, CLR_BRIGHT_BLUE),
    ...
    MON("boar", S_QUADRUPED, LVL(2, 12, 7, 0, 0), (G_GENO | 0),
        A(ATTK(AT_BUTT, AD_PHYS, 1, 4), ATTK(AT_BUTT, AD_PHYS, 1, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(200, 100, MS_GROWL, MZ_MEDIUM), 0, 0,
    ...
    MON("chimera", S_QUADRUPED, LVL(10, 12, 4, 20, -1), (G_GENO | 2),
        ...
        M2_NASTY, M3_INFRAVISIBLE, CLR_GREEN),
    ...
    MON("hellbear", S_QUADRUPED, LVL(16, 13, 5, 0, -1),
        ...
        M2_HOSTILE | M2_STRONG, M3_INFRAVISIBLE, CLR_RED),
    ...
    MON("packrat", S_RODENT, LVL(3, 12, 7, 0, 0), (G_GENO | 1),
        ...
        SIZ(30, 30, MS_SQEEK, MZ_TINY), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_COLLECT | M2_STRONG, M3_INFRAVISIBLE, CLR_YELLOW),
    ...
    MON("koala", S_ZOUTHERN, LVL(7, 4, 9, 10, 0), (G_NOHELL | G_GENO | 2),
    	...
    	M1_ANIMAL | M1_HERBIVORE | M1_SEE_INVIS, M2_DOMESTIC, 0, CLR_GRAY),
    ...
    MON("phoenix", S_BAT, LVL(15, 20, -7, 40, 7), (G_GENO | G_NOCORPSE | 2),
        ...
        M2_WANDER | M2_STRONG | M2_NASTY, M3_INFRAVISIBLE, CLR_ORANGE),
    ...
    MON("baby purple dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), G_GENO,
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_GREEDY | M2_JEWELS, 0, CLR_BRIGHT_MAGENTA),
    ...
    MON("brown mold warrior", S_FUNGUS, LVL(5, 12, 8, 0, 0),
        ...
        M2_STALK | M2_NEUTER | M2_HOSTILE, M3_INFRAVISION, CLR_BROWN),
    MON("yellow mold warrior", S_FUNGUS, LVL(5, 12, 8, 0, 0),
        ...
        M1_BREATHLESS | M1_HUMANOID | M1_NOEYES,
        M2_STALK | M2_NEUTER | M2_HOSTILE, M3_INFRAVISION, CLR_YELLOW),
    MON("green mold warrior", S_FUNGUS, LVL(5, 12, 8, 0, 0),
        (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 4), ATTK(AT_NONE, AD_ACID, 0, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 200, MS_SILENT, MZ_HUMAN),
        MR_SLEEP | MR_ACID | MR_STONE, MR_STONE,
        M1_BREATHLESS | M1_HUMANOID | M1_NOEYES,
        M2_STALK | M2_NEUTER | M2_HOSTILE, M3_INFRAVISION, CLR_GREEN),
    MON("red mold warrior", S_FUNGUS, LVL(5, 12, 8, 0, 0),
        ...
        MR_SLEEP | MR_ACID | MR_STONE, MR_STONE,
        M1_BREATHLESS | M1_HUMANOID | M1_NOEYES,
        M2_STALK | M2_NEUTER | M2_HOSTILE, M3_INFRAVISION, CLR_RED),
    /*
     * Gnomes
     */
...
struct permonst _mons2[] = {
    ...
    MON("wandering cactus", S_PLANT, LVL(3, 3, 2, 40, 0),
        ...
        M1_BREATHLESS | M1_HUMANOID | M1_THICK_HIDE, M2_WANDER, 0, CLR_YELLOW),
    ...
    MON("walking willow", S_PLANT, LVL(14, 7, -2, 60, 0),
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 5, 4), ATTK(AT_TUCH, AD_WIND, 3, 3), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1200, 0, MS_SILENT, MZ_LARGE), MR_COLD, 0,
        M1_BREATHLESS | M1_HUMANOID | M1_THICK_HIDE, M2_STRONG, 0, CLR_BLACK),
    ...
    MON("crazy cactus", S_PLANT, LVL(13, 15, 2, 40, -3),
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 3, 4), ATTK(AT_NONE, AD_QUIL, 2, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 0, MS_SILENT, MZ_LARGE), MR_FIRE, 0,
        M1_BREATHLESS | M1_HUMANOID | M1_THICK_HIDE, M2_WANDER, 0, CLR_ORANGE),
    /*
     * Puddings
     *
    ...
    MON("blood pudding", S_PUDDING, LVL(7, 5, 4, 0, 0),
        ...
        M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_MINDLESS | M1_OMNIVORE | M1_ACID,
        M2_HOSTILE | M2_NEUTER | M2_NASTY, 0, CLR_RED),
    ...
    MON("amalgamation", S_QUANTMECH, LVL(10, 6, 5, 10, 0),
        ...
        M2_HOSTILE | M2_NOPOLY, 0, CLR_WHITE),
    ...
    MON("amphisbaena", S_SNAKE, LVL(9, 3, 5, 0, -3), (G_GENO | 1),
        ...
        M1_SWIM | M1_NOLIMBS | M1_ANIMAL | M1_SLITHY | M1_CARNIVORE
            | M1_OVIPAROUS | M1_NOTAKE,
        M2_HOSTILE | M2_STRONG, M3_INFRAVISION, CLR_ORANGE),
    /*
     * Trolls
     */
    ...
    MON("rock troll", S_TROLL, LVL(9, 12, 0, 0, -3), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, CLR_CYAN),
    MON("water troll", S_TROLL, LVL(11, 14, 4, 40, -3), (G_GENO),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 8), ATTK(AT_CLAW, AD_PHYS, 2, 8),
          ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("nosferatu", S_VAMPIRE, LVL(20, 14, -4, 50, -9),
        (G_GENO | G_NOCORPSE | 1),
      	...
      	M1_FLY | M1_BREATHLESS | M1_HUMANOID | M1_POIS | M1_REGEN,
      	M2_UNDEAD | M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY | M2_LORD
          | M2_MALE | M2_MAGIC, M3_INFRAVISIBLE, CLR_GRAY),
    MON("Alucard", S_VAMPIRE, LVL(24, 20, -6, 70, -10),
        ...
        M3_WAITFORU | M3_INFRAVISIBLE, HI_LORD),
    ...
    MON("draugr", S_ZOMBIE, LVL(5, 6, 8, 0, -3),
        ...
        MR_COLD | MR_SLEEP | MR_POISON, MR_COLD,
        M1_BREATHLESS | M1_HUMANOID,
        M2_UNDEAD | M2_STALK | M2_HOSTILE, M3_INFRAVISION, CLR_BLUE),
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("merfolk", S_EEL, LVL(3, 12, 4, 10, 0),
        ...
        M2_COLLECT | M2_MERFOLK | M2_HOSTILE, M3_INFRAVISIBLE, CLR_GREEN),
    ...
    MON("sea horse", S_EEL, LVL(6, 20, 5, 0, 0), (G_GENO | 2),
        ...
        M1_SLITHY,
        M2_WANDER | M2_STRONG | M2_DOMESTIC, M3_INFRAVISIBLE, HI_DOMESTIC),
