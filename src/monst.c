...
NEARDATA struct permonst mons[] = {
    ...
    MON("memory hound", S_DOG, LVL(7, 12, 2, 0, 3), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_MEMR, 3, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(250, 200, MS_BARK, MZ_SMALL), MR_COLD, MR_COLD,
        M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, M3_INFRAVISION, 9, CLR_BLUE),
    ...
    MON("alpha werewolf", S_DOG, LVL(12, 18, 2, 20, -7), (G_NOGEN | G_NOCORPSE),
        ...
        SIZ(500, 250, MS_BARK, MZ_MEDIUM), MR_POISON, 0,
        M1_NOHANDS | M1_POIS | M1_REGEN | M1_CARNIVORE,
        M2_NOPOLY | M2_WERE | M2_HOSTILE, M3_INFRAVISIBLE, 16, CLR_BROWN),
#ifdef CHARON
    ...
    MON("cheshire cat", S_FELINE, LVL(7, 12, 3, 20, -1), (G_HELL | 1),
        ...
        M3_INFRAVISIBLE, 9, CLR_BRIGHT_MAGENTA),
    ...
    MON("dust devil", S_IMP, LVL(6, 20, -6, 20, 11),
        ...
        M1_POIS | M1_FLY | M1_THICK_HIDE, M2_DEMON | M2_STALK | M2_HOSTILE |
        M2_NASTY, 0, 10, CLR_YELLOW),
    /*
     * jellies
     */
    ...
    MON("goblin windmage", S_ORC, LVL(3, 6, 10, 0, -3), (G_GENO | 1),
        A(ATTK(AT_TUCH, AD_WIND, 1, 2), ATTK(AT_WEAP, AD_PHYS, 1, 2),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 100, MS_ORC, MZ_SMALL), 0, 0, M1_HUMANOID | M1_OMNIVORE,
        M2_ORC | M2_COLLECT, M3_INFRAVISIBLE | M3_INFRAVISION, 5, CLR_CYAN),
    ...
    MON("bear", S_QUADRUPED, LVL(4, 12, 7, 0, 0), (G_GENO | 2),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_OMNIVORE, M2_STRONG, M3_INFRAVISIBLE,
        5, CLR_BLACK),
    MON("werebear", S_QUADRUPED, LVL(4, 12, 7, 0, 0), (G_GENO | G_NOCORPSE),
        ...
        M2_NOPOLY | M2_WERE | M2_STRONG, M3_INFRAVISIBLE,
        7, CLR_BLACK),
    ...
    MON("earthshark", S_QUADRUPED, LVL(7, 12, 2, 0, 0), (G_GENO | 2),
        ...
        M2_HOSTILE | M2_STRONG, 0, 9, CLR_GRAY),
    ...
    MON("packrat", S_RODENT, LVL(3, 12, 7, 0, 0), (G_GENO | 1),
        ...
        SIZ(30, 30, MS_SQEEK, MZ_TINY), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_COLLECT | M2_STRONG, M3_INFRAVISIBLE, 4, CLR_YELLOW),
    ...
    MON("jumping spider", S_SPIDER, LVL(6, 15, 4, 0, 0), (G_GENO | 1),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_OVIPAROUS | M1_POIS | M1_CARNIVORE
            | M1_CONCEAL,
        M2_HOSTILE | M2_STRONG, 0, 8, CLR_BLUE),
    ...
    MON("pale horse", S_UNICORN, LVL(15, 24, 4, 70, 0), (G_NOGEN),
        ...
        M2_STRONG | M2_HOSTILE | M2_NOPOLY, M3_INFRAVISIBLE, 17, CLR_GRAY),
    MON("white horse", S_UNICORN, LVL(15, 24, 4, 70, 0), (G_NOGEN),
        A(ATTK(AT_KICK, AD_PHYS, 1, 10), ATTK(AT_BITE, AD_PHYS, 1, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1800, 350, MS_NEIGH, MZ_LARGE), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_HERBIVORE | M1_FLY,
        M2_STRONG | M2_HOSTILE | M2_UNDEAD | M2_NOPOLY, M3_INFRAVISIBLE,
        17, CLR_GRAY),
     ...
     */
     MON("death maggot", S_WORM, LVL(1, 12, 5, 0, 0), (G_GENO | G_SGROUP | 2),
         ...
         M2_HOSTILE | M2_UNDEAD, 0, 2, CLR_GREEN),
    MON("acid worm", S_WORM, LVL(4, 9, 5, 0, 0), (G_GENO | G_SGROUP | 1),
       	...
       	M2_HOSTILE, 0, 7, CLR_BRIGHT_GREEN),
    ...
    MON("wallaby", S_ZOUTHERN, LVL(5, 16, 7, 0, 0), (G_NOHELL | G_GENO | 1),
      ...
      M1_ANIMAL | M1_HERBIVORE, 0, 0, 6, CLR_BROWN),
    ...
    MON("wallaroo", S_ZOUTHERN, LVL(6, 20, 8, 0, 0),
      ...
      M1_ANIMAL | M1_HERBIVORE, 0, 0, 8, CLR_RED),
    /* nerfed damage output */
    MON("kangaroo", S_ZOUTHERN, LVL(10, 24, 6, 0, 0),
      ...
      M1_ANIMAL | M1_HERBIVORE, M2_NASTY, 0, 12, CLR_GRAY),
    /*
    ...
    MON("Avenger Archon", S_ANGEL, LVL(16, 18, -4, 30, 15),
        ...
        M2_NOPOLY | M2_MINION | M2_STALK | M2_STRONG | M2_NASTY
            | M2_COLLECT | M2_MAGIC,
        M3_INFRAVISIBLE | M3_INFRAVISION, 21, CLR_BRIGHT_GREEN),
    MON("Herald Archon", S_ANGEL, LVL(16, 16, -6, 50, 15),
        ...
        M2_NOPOLY | M2_MINION | M2_STALK | M2_STRONG | M2_NASTY
            | M2_COLLECT | M2_MAGIC,
        M3_INFRAVISIBLE | M3_INFRAVISION, 20, CLR_CYAN),
    ...
    MON("hellbat", S_BAT, LVL(7, 22, 7, 0, 0),
      ...
      MR_FIRE, MR_FIRE, M1_FLY | M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE,
    	M2_WANDER | M2_HOSTILE, M3_INFRAVISIBLE, 9, CLR_RED),
   ...
   MON("fell beast", S_DRAGON, LVL(14, 12, -2, 20, -17), (G_NOGEN | 1),
    ...
    MON("storm elemental", S_ELEMENTAL, LVL(8, 12, 2, 30, 0), (G_NOCORPSE | 1),
        ...
        M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS | M1_BREATHLESS
            | M1_UNSOLID | M1_FLY,
        M2_STRONG | M2_NEUTER, 0, 10, CLR_GRAY),
    ...
    MON("magma elemental", S_ELEMENTAL, LVL(8, 6, 2, 30, 0), (G_NOCORPSE | 1),
        ...
        M2_STRONG | M2_NEUTER, M3_INFRAVISIBLE, 10, CLR_ORANGE),
    ...
    MON("legendary lichen", S_FUNGUS, LVL(4, 3, 9, 0, 0), (G_GENO | 2),
        ...
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER | M2_LORD, 0, 6, HI_LORD),
    ...
    MON("brown mold warrior", S_FUNGUS, LVL(5, 12, 8, 0, 0),
        ...
        M2_STALK | M2_NEUTER | M2_HOSTILE, M3_INFRAVISION, 7, CLR_BROWN),
    MON("yellow mold warrior", S_FUNGUS, LVL(5, 12, 8, 0, 0),
        ...
        M1_BREATHLESS | M1_HUMANOID | M1_NOEYES,
        M2_STALK | M2_NEUTER | M2_HOSTILE, M3_INFRAVISION, 7, CLR_YELLOW),
    MON("green mold warrior", S_FUNGUS, LVL(5, 12, 8, 0, 0),
        ...
        M1_BREATHLESS | M1_HUMANOID | M1_NOEYES,
        M2_STALK | M2_NEUTER | M2_HOSTILE, M3_INFRAVISION, 7, CLR_GREEN),
    MON("red mold warrior", S_FUNGUS, LVL(5, 12, 8, 0, 0),
        ...
        M1_BREATHLESS | M1_HUMANOID | M1_NOEYES,
        M2_STALK | M2_NEUTER | M2_HOSTILE, M3_INFRAVISION, 7, CLR_RED),
    /*
     * Gnomes
     */
    ...
    MON("gnomish psychic", S_GNOME, LVL(3, 10, 4, 10, 0), (G_GENO | 1),
        A(ATTK(AT_MAGC, AD_PSYC, 2, 1), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(700, 120, MS_ORC, MZ_SMALL), 0, 0, M1_HUMANOID | M1_OMNIVORE,
        M2_GNOME | M2_MAGIC, M3_INFRAVISIBLE | M3_INFRAVISION, 5,
        CLR_BRIGHT_MAGENTA),
...
struct permonst _mons2[] = {
    ...
    MON("worm that walks", S_LICH, LVL(11, 6, 0, 30, -9),
        ...
        M2_UNDEAD | M2_HOSTILE | M2_MAGIC, M3_INFRAVISION, 15, CLR_GREEN),
    ...
    MON("lord of worms", S_LICH, LVL(25, 9, -6, 90, -15),
        ...
        M1_BREATHLESS | M1_HUMANOID | M1_POIS | M1_REGEN,
        M2_UNDEAD | M2_HOSTILE | M2_MAGIC, M3_WANTSBOOK | M3_INFRAVISION, 30,
        CLR_BRIGHT_GREEN),
    /*
     * Mummies
     */
    ...
    MON("wandering cactus", S_PLANT, LVL(3, 3, 2, 40, 0),
        ...
        M1_BREATHLESS | M1_HUMANOID | M1_THICK_HIDE, M2_WANDER, 0,
        5, CLR_YELLOW),
    MON("walking oak", S_PLANT, LVL(7, 3, 2, 40, 7),
        ...
        M1_BREATHLESS | M1_HUMANOID | M1_THICK_HIDE, M2_STRONG, 0, 9, HI_WOOD),
    MON("walking birch", S_PLANT, LVL(9, 5, 0, 20, -3),
        (G_NOCORPSE | G_GENO | G_SGROUP | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 4, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1200, 0, MS_HUMANOID, MZ_LARGE), MR_COLD, 0,
        M1_BREATHLESS | M1_HUMANOID | M1_THICK_HIDE, M2_STRONG, 0,
        11, CLR_WHITE),
    ...
    MON("giant sundew", S_PLANT, LVL(11, 9, 3, 20, 0), (G_NOCORPSE | G_GENO | 1),
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_NOLIMBS | M1_ACID | M1_BREATHLESS
            | M1_HIDE | M1_CARNIVORE | M1_NOTAKE, M2_HOSTILE, 0, 14, CLR_RED),
    ...
    MON("Ancient Brain", S_PUDDING, LVL(15, 12, 10, 50, 13), (G_UNIQ | G_NOGEN),
      A(ATTK(AT_MAGC, AD_PSYC, 2, 4), ATTK(AT_MAGC, AD_PSYC, 2, 4),
        ...
        M2_HOSTILE | M2_NEUTER, 0, 21, HI_LORD),
    /*
     * Strange beings
     */
    ...
    MON("amalgamation", S_QUANTMECH, LVL(10, 6, 5, 10, 0),
        ...
        M2_HOSTILE | M2_NOPOLY, 0, 12, CLR_WHITE),
    MON("genetic engineer", S_QUANTMECH, LVL(12, 12, 3, 10, 0),
        ...
        M2_HOSTILE, M3_INFRAVISIBLE, 14, CLR_GREEN),
    ...
    MON("lindorm", S_SNAKE, LVL(7, 7, 1, 20, -4), (G_GENO | 3),
        A(ATTK(AT_BITE, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 1,4),
          ...
          M2_HOSTILE, M3_INFRAVISION, 9, CLR_CYAN),
    ...
    MON("nosferatu", S_VAMPIRE, LVL(20, 14, -4, 50, -9),
        (G_GENO | G_NOCORPSE | 1),
      	...
      	M1_FLY | M1_BREATHLESS | M1_HUMANOID | M1_POIS | M1_REGEN,
      	M2_UNDEAD | M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY | M2_LORD
          | M2_MALE | M2_MAGIC, M3_INFRAVISIBLE, 25, CLR_GRAY),
    MON("Alucard", S_VAMPIRE, LVL(24, 20, -6, 70, -10),
        ...
        M3_WAITFORU | M3_INFRAVISIBLE, 29, HI_LORD),
    ...
    MON("draugr", S_ZOMBIE, LVL(5, 6, 8, 0, -3),
        ...
        M1_BREATHLESS | M1_HUMANOID,
        M2_UNDEAD | M2_STALK | M2_HOSTILE, M3_INFRAVISION, 7, CLR_BLUE),
    ...
    MON("ghast", S_ZOMBIE,  LVL(4, 6, 10, 0, -2), (G_GENO | G_NOCORPSE | 1),
      	...
      	M2_UNDEAD | M2_STALK | M2_HOSTILE, 0, 6, CLR_MAGENTA),
    ...
    MON("rook", S_GOLEM, LVL(9, 12, -4, 0, 0), (G_NOCORPSE | 1),
        ...
        M2_HOSTILE | M2_NEUTER, 0, 11, CLR_WHITE),
    ...
    MON("sludge golem", S_GOLEM, LVL(15, 7, 3, 50, 0), (G_NOCORPSE | 1),
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE,
        M2_HOSTILE | M2_STRONG, 0, 17, CLR_BRIGHT_GREEN),
    ...
    MON("drow", S_HUMAN, LVL(6, 12, 10, 60, -9), (G_GENO | G_SGROUP | 1),
      	...
      	SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
      	M1_HUMANOID | M1_OMNIVORE,
      	M2_NOPOLY | M2_ELF | M2_STRONG | M2_LORD | M2_COLLECT | M2_HOSTILE,
      	0, 11, CLR_BLACK),
    ...
    MON("pack lord", S_HUMAN, LVL(12, 12, 10, 50, -7), (1),
        ...
        SIZ(WT_HUMAN, 400, MS_WERE, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_POIS | M1_REGEN | M1_OMNIVORE,
        M2_NOPOLY | M2_WERE | M2_HOSTILE | M2_HUMAN | M2_COLLECT | M2_MAGIC,
        M3_INFRAVISIBLE, 13, CLR_ORANGE),
    ...
    MON("master of cats", S_HUMAN, LVL(14, 18, 5, 50, 0), (G_UNIQ | 1),
        ...
        M3_INFRAVISION | M3_INFRAVISIBLE, 16, HI_LORD),
    ...
    MON("spectre", S_GHOST, LVL(10, 9, -8, 50, -5), (G_NOCORPSE | 1),
        ...
        MR_COLD | MR_DISINT | MR_SLEEP | MR_POISON | MR_STONE, 0,
        M1_FLY | M1_BREATHLESS | M1_WALLWALK | M1_HUMANOID | M1_UNSOLID,
        M2_NOPOLY | M2_UNDEAD | M2_STALK | M2_HOSTILE, M3_INFRAVISION, 12,
        CLR_BRIGHT_BLUE),
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("infernal", S_DEMON, LVL(0, 12, 10, 0, 0), G_NOGEN, /* for corpses */
        ...
        M2_COLLECT, M3_INFRAVISIBLE | M3_INFRAVISION, 2, HI_DOMESTIC),
    ...
    MON("horned devil", S_DEMON, LVL(6, 9, -5, 50, 11),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 9, CLR_YELLOW),
    ...
    MON("erinys", S_DEMON, LVL(7, 12, 2, 30, 10),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 10, CLR_BRIGHT_BLUE),
    ...
    MON("marilith", S_DEMON, LVL(7, 12, -6, 80, -12),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 11, CLR_BRIGHT_CYAN),
    MON("vrock", S_DEMON, LVL(8, 12, 0, 50, -9),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 11, CLR_BRIGHT_MAGENTA),
    MON("hezrou", S_DEMON, LVL(9, 6, -2, 55, -10),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 12, CLR_BROWN),
    ...
    MON("ice devil", S_DEMON, LVL(11, 6, -4, 55, -12),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 14, CLR_CYAN),
    MON("nuckelavee", S_DEMON, LVL(11, 18, -3, 50, -12),
      ...
      MR_FIRE | MR_POISON, 0, M1_SEE_INVIS | M1_POIS | M1_SWIM, M2_DEMON |
      M2_STALK | M2_HOSTILE | M2_NASTY,
      M3_INFRAVISIBLE | M3_INFRAVISION, 16, CLR_BRIGHT_GREEN),
    MON("nalfeshnee", S_DEMON, LVL(11, 9, -1, 65, -11),
        ...
        M1_HUMANOID | M1_POIS, M2_DEMON | M2_STALK | M2_HOSTILE | M2_NASTY,
        M3_INFRAVISIBLE | M3_INFRAVISION, 15, CLR_BLACK),
    MON("pit fiend", S_DEMON, LVL(13, 6, -3, 65, -13),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 16, CLR_ORANGE),
    ...
    MON("headless horseman", S_DEMON, LVL(14, 15, 10, 40, 0),
        ...
        M2_NASTY | M2_COLLECT | M2_HOSTILE, M3_INFRAVISIBLE | M3_INFRAVISION,
        16, CLR_WHITE),
    ...
    MON("Buer", S_DEMON, LVL(52, 20, -15, 70, -15),
        ...
        M3_WANTSAMUL | M3_INFRAVISIBLE | M3_INFRAVISION, 28, HI_LORD),
    ...
    MON("King in Yellow", S_DEMON, LVL(118, 15, -20, 100, 0),
        ...
        M3_WANTSALL | M3_INFRAVISIBLE | M3_INFRAVISION, 67, CLR_YELLOW),
    ...
    MON("merfolk", S_EEL, LVL(3, 12, 4, 10, 0),
        ...
        M2_COLLECT | M2_MERFOLK | M2_HOSTILE, M3_INFRAVISIBLE, 5, CLR_GREEN),
    ...
    MON("sea horse", S_EEL, LVL(6, 20, 5, 0, 0), (G_GENO | 2),
        ...
        M1_SLITHY,
        M2_WANDER | M2_STRONG | M2_DOMESTIC, M3_INFRAVISIBLE, 8, HI_DOMESTIC),
    ...
    MON("velociraptor", S_LIZARD, LVL(7, 18, 5, 0, 0), (G_GENO | G_SGROUP | 1),
        ...
        M1_SWIM | M1_AMPHIBIOUS | M1_ANIMAL | M1_THICK_HIDE | M1_NOHANDS
            | M1_CARNIVORE,
        M2_STRONG | M2_HOSTILE, 0, 9, CLR_WHITE),
    ...
    MON("T-Rex", S_LIZARD, LVL(10, 9, 5, 0, 0), (G_GENO | 1),
        ...
        M2_STRONG | M2_HOSTILE, 0, 11, CLR_WHITE),
    ...
    MON("caveperson", S_HUMAN, LVL(10, 12, 10, 0, 1), G_NOGEN,
        ...
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_NEUTER | M2_COLLECT,
        M3_INFRAVISIBLE, 12, HI_DOMESTIC),
    ...
    MON("Drakemother", S_DRAGON, LVL(25, 18, -1, 20, -4), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC |
        M2_FEMALE,
        M3_CLOSE | M3_INFRAVISIBLE, 30, HI_LORD),
    ...
    MON("Dal Zethire", S_HUMAN, LVL(15, 12, 0, 80, -10),
        ...
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISIBLE, 19, CLR_RED),
#if 0 /* OBSOLETE */
    ...
    MON("Blackbeard's Ghost", S_GHOST, LVL(15, 12, -5, 50, -30),
        (G_NOCORPSE | G_NOGEN | G_UNIQ),
      	...
      	M1_FLY | M1_BREATHLESS | M1_WALLWALK | M1_HUMANOID | M1_UNSOLID |
        M1_HUMANOID | M1_OMNIVORE,
      	M2_NOPOLY | M2_UNDEAD | M2_STALK | M2_HOSTILE | M2_HUMAN | M2_STRONG |
    ...
    MON("Dark One", S_HUMAN, LVL(15, 12, 0, 80, -10),
        ...
        M2_NOPOLY | M2_HUMAN | M2_STRONG | M2_HOSTILE | M2_STALK | M2_NASTY
            | M2_COLLECT | M2_MAGIC,
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISIBLE, 21, CLR_BLACK),
    /*
     * quest "guardians"
     */
