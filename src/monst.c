...
NEARDATA struct permonst mons_init[] = {
   ...
   MON("fell beast", S_DRAGON, LVL(14, 12, -2, 20, -17), G_NOGEN,
    ...
    MON("baby red dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), (G_GENO | G_NOGEN | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
...
struct permonst _mons2[] = {
    ...
    MON("minotaur", S_GIANT, LVL(15, 15, 6, 0, 0), (G_GENO | G_NOGEN | 1),
    ...
    MON("lawyer", S_LICH, LVL(11, 9, 0, 20, 5), (G_NOGEN | 1),
        A(ATTK(AT_MAGC, AD_LAWS, 4, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("ulsfark", S_HUMAN, LVL(5, 15, 8, 1, -7), (G_NOGEN | 3),
    ...
    MON("ronin", S_HUMAN, LVL(10, 12, 10, 1, -3), (G_NOGEN | 2),
    ...
    MON("dark knight", S_HUMAN, LVL(13, 12, 10, 1, 3), (G_NOGEN | 1),
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("salamander", S_LIZARD, LVL(8, 12, -1, 0, -9), (G_HELL | 1),
        ...
        12, CLR_ORANGE),
    MON("T-Rex", S_LIZARD, LVL(15, 15, 5, 0, 0), (G_NOGEN | 2),
        ...
        M2_STRONG | M2_HOSTILE, 0, 0, 18, CLR_RED),
    ...
    MON("thug", S_HUMAN, LVL(5, 12, 10, 10, -3), G_NOGEN,
        ...
        M3_INFRAVISIBLE, MH_HUMAN, 7, HI_DOMESTIC),
    MON("ninja", S_HUMAN, LVL(5, 12, 10, 10, 3), (G_NOGEN | 2),
