...
struct obj *otmp;
{
    ...
    return ((putting_on(word)
             && ((otmp->oclass == FOOD_CLASS && otyp != MEAT_RING && otyp != PUMPKIN)
                 || (otmp->oclass == TOOL_CLASS && otyp != BLINDFOLD && otyp != EARMUFFS
                     && otyp != TOWEL && otyp != LENSES && otyp != MASK)))
            || (!strcmp(word, "wield")
                && (otmp->oclass == TOOL_CLASS && !is_weptool(otmp)))
            || (!strcmp(word, "drink") && (otmp->oclass == TOOL_CLASS && otyp != KEG))
        ...
        || (!strcmp(word, "rub")
            ...
            || (!strcmp(word, "use or apply")
                ...
                && ((otmp->oclass == WEAPON_CLASS
                     ...
                     && otyp != FLAMING_LASH && otyp != RAZOR_WHIP
                     && otyp != SUBMACHINE_GUN
                     && otyp != AUTO_SHOTGUN
                     && otyp != FRAG_GRENADE
                     && otyp != GAS_GRENADE)
