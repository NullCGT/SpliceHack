...
/* Utility Macros */
/* These macros are shorthand for common phrases in the monst.c file. */
/* An empty set of attacks. */
#define NO_ATTKS A(NO_ATTK, NO_ATTK, NO_ATTK, \
                   NO_ATTK, NO_ATTK, NO_ATTK)
/* An empty size struct. */
#define NO_SIZ SIZ(0, 0, 0, 0)
...
NEARDATA struct permonst mons_init[] = {
    ...
    MON("giant praying mantis", S_ANT, LVL(7, 12, 2, 0, 0), (G_GENO | 2),
        ...
        9, CLR_GREEN),
    MON("giant ichneumon", S_ANT, LVL(8, 18, -1, 0, 0), (G_GENO | 2),
        ...
        M2_HOSTILE | M2_NASTY | M2_FEMALE, 0, 12, CLR_BRIGHT_BLUE),
    ...
    MON("assassin bug", S_ANT, LVL(10, 24, 4, 0, 0), (G_NOHELL | G_GENO | 1),
      	...
      	M1_ANIMAL | M1_NOHANDS | M1_POIS | M1_CARNIVORE,
      	M2_HOSTILE | M2_FLANK, 0, 12, CLR_BLACK),
    ...
    MON("winter wolf pup", S_DOG, LVL(3, 12, 6, 0, -7), (G_GENO | G_NOGEN),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE, 0, 3, CLR_CYAN),
    MON2("werejackal", S_DOG, LVL(2, 12, 7, 10, -7), (G_NOGEN | G_NOCORPSE),
        ...
        M2_NOPOLY | M2_HOSTILE, M3_INFRAVISIBLE, MH_WERE, 4, CLR_BROWN),
    ...
    MON2("werewolf", S_DOG, LVL(5, 12, 4, 20, -7), (G_NOGEN | G_NOCORPSE),
        A(ATTK(AT_BITE, AD_WERE, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(500, 250, MS_BARK, MZ_MEDIUM), MR_POISON, 0,
        M1_NOHANDS | M1_POIS | M1_REGEN | M1_CARNIVORE,
        M2_NOPOLY | M2_HOSTILE, M3_INFRAVISIBLE, MH_WERE, 7, CLR_BROWN),
    ...
    MON("thought eater", S_DOG, LVL(7, 12, 2, 0, -3), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_BITE, AD_MEMR, 2, 4), ATTK(AT_TUCH, AD_PSYC, 2, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(250, 200, MS_BARK, MZ_SMALL), MR_COLD, MR_COLD,
        M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE | M2_FLANK, M3_INFRAVISION,
        9, CLR_BRIGHT_BLUE),
    MON("winter wolf", S_DOG, LVL(7, 12, 4, 20, 0), (G_NOHELL | G_GENO | 1),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE | M2_FLANK | M2_STRONG,
        0, 9, CLR_CYAN),
    ...
    MON("guard dog", S_DOG, LVL(10, 14, 4, 0, 0), (G_GENO | G_NOGEN),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_STRONG | M2_DOMESTIC,
        M3_INFRAVISIBLE | M3_INFRAVISION, 9, HI_DOMESTIC),
    ...
    MON2("pack lord", S_DOG, LVL(12, 18, 2, 20, -7), (G_NOGEN | G_NOCORPSE),
        A(ATTK(AT_BITE, AD_WERE, 2, 6), ATTK(AT_BITE, AD_WERE, 2, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(500, 250, MS_BARK, MZ_MEDIUM), MR_POISON, 0,
        M1_NOHANDS | M1_POIS | M1_REGEN | M1_CARNIVORE,
        M2_NOPOLY | M2_HOSTILE | M2_FLANK, M3_INFRAVISIBLE, MH_WERE,
        16, CLR_BROWN),
#ifdef CHARON
    ...
    MON("weeping eye", S_EYE, LVL(2, 1, 9, 10, 0), (G_GENO | 2),
        ...
        SIZ(10, 10, MS_SILENT, MZ_SMALL), 0, 0,
        M1_FLY | M1_AMPHIBIOUS | M1_NOLIMBS | M1_NOHEAD | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE, 3, CLR_BROWN),
    MON("glowing eye", S_EYE, LVL(5, 3, 4, 0, 0), (G_NOHELL | G_GENO | 1),
    	...
    	M2_HOSTILE | M2_NEUTER, 0, 7, CLR_YELLOW),
    ...
    MON("whirling sphere", S_EYE, LVL(6, 13, 4, 0, 0),
        ...
        M1_FLY | M1_BREATHLESS | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, 0, 7, CLR_CYAN),
    ...
    MON("concussive sphere", S_EYE, LVL(6, 13, 4, 0, 0),
        ...
        M1_FLY | M1_BREATHLESS | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, 0, 8, CLR_BRIGHT_CYAN),
    MON("psionic sphere", S_EYE, LVL(6, 13, 4, 0, 0),
        ...
        M2_HOSTILE | M2_NEUTER, 0, 8, CLR_BRIGHT_MAGENTA),
    MON("bloodshot eye", S_EYE, LVL(6, 3, 4, 0, 0), (G_NOHELL | G_GENO | 1),
      	A(ATTK(AT_GAZE, AD_STUN, 3, 4), NO_ATTK, NO_ATTK,
      	  NO_ATTK, NO_ATTK, NO_ATTK),
      	SIZ(10, 10, MS_SILENT, MZ_SMALL), 0, 0,
      	M1_FLY | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS,
      	M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE, 8, CLR_BRIGHT_MAGENTA),
    MON("blinking eye", S_EYE, LVL(8, 4, 4, 0, 0), (G_NOHELL | G_GENO | 1),
      	...
      	M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE, 10, CLR_CYAN),
    ...
    MON("magical eye", S_EYE, LVL(9, 6, 4, 90, -10), (G_GENO | 2),
          ...
          M3_INFRAVISIBLE | M3_INFRAVISION, 14, HI_LORD),
    MON("sphere of the void", S_EYE, LVL(25, 4, -3, 100, 0), (G_NOCORPSE | 1),
          ...
          M1_FLY | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS | M1_NOTAKE
            | M1_WALLWALK,
          M2_NOPOLY | M2_NEUTER | M2_NASTY, M3_DISPLACES, 30, HI_LORD),
    /*
     * felines
     */
    MON("serval", S_FELINE, LVL(0, 13, 8, 0, 0), (G_GENO | 2),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE,
        M2_WANDER | M2_JUMPER,
        M3_INFRAVISIBLE | M3_INFRAVISION, 1, CLR_GRAY),
    ...
    MON2("weretiger", S_FELINE, LVL(7, 12, 6, 20, -7), (G_NOGEN | G_NOCORPSE),
    ...
    MON("serpopard", S_FELINE, LVL(6, 15, 6, 0, 0), (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 3), ATTK(AT_CLAW, AD_PHYS, 2, 3),
          ATTK(AT_HUGS, AD_WRAP, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 300, MS_GROWL, MZ_LARGE), 0, 0,
        M1_ANIMAL | M1_SLITHY | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE,
        M3_INFRAVISIBLE, 8, CLR_BLUE),
    /* Lions hunt in packs, and the females do most of the hunting */
    MON3("lion", "lioness", "lion",
        S_FELINE, LVL(6, 12, 6, 0, 0), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4),
          ATTK(AT_BITE, AD_PHYS, 1, 10), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 300, MS_GROWL, MZ_LARGE), 0, 0,
    ...
    MON("fat cat", S_FELINE, LVL(10, 14, 3, 0, 0), (G_GENO | G_NOGEN),
        ...
        M3_INFRAVISIBLE, 10, HI_DOMESTIC),
    ...
    MON2("hellcat", S_FELINE, LVL(12, 12, 6, 0, 0), (G_HELL | G_GENO | 3),
      	A(ATTK(AT_CLAW, AD_PHYS, 4, 4), ATTK(AT_CLAW, AD_PHYS, 4, 4),
      	  ATTK(AT_BITE, AD_FIRE, 3, 10), NO_ATTK, NO_ATTK, NO_ATTK),
      	SIZ(800, 400, MS_GROWL, MZ_LARGE), 0, 0,
      	M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE | M2_FLANK,
        M3_INFRAVISIBLE, MH_DEMON, 14, CLR_RED),
    /*
     * gremlins and gargoyles
     */
    MON3("telamon", "caryatid", "loadbearer", S_GREMLIN, LVL(2, 10, 4, 20, 3),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 12), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(1200, 400, MS_HUMANOID, MZ_HUMAN), MR_POISON | MR_STONE, 0,
        M1_HUMANOID | M1_THICK_HIDE | M1_BREATHLESS, M2_STRONG | M2_FLANK,
        0, 3, CLR_GRAY),
    ...
    MON("hobbit", S_HUMANOID, LVL(1, 9, 10, 0, 6), (G_GENO | 2),
        ...
        M2_COLLECT | M2_FLANK, M3_INFRAVISIBLE | M3_INFRAVISION, 2, CLR_GREEN),
    MON2("dwarf", S_HUMANOID, LVL(2, 6, 10, 10, 4), (G_GENO | 3),
    ...
    MON4("dwarf lord", "dwarf lady", "dwarf leader",
    ...
    MON("deep one", S_HUMANOID, LVL(7, 9, 5, 10, -5), (G_GENO | G_LGROUP | 2),
        ...
        M2_HOSTILE | M2_STALK | M2_GREEDY | M2_JEWELS | M2_COLLECT | M2_MAGIC | M2_FLANK,
        M3_INFRAVISIBLE | M3_INFRAVISION, 9, CLR_BRIGHT_GREEN),
    ...
    MON("mind flayer telepath", S_HUMANOID, LVL(11, 9, 4, 90, -8),
        ...
        M1_HUMANOID | M1_FLY | M1_SEE_INVIS | M1_OMNIVORE,
        M2_HOSTILE | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 16, CLR_MAGENTA),
    MON2("vampiric mind flayer", S_HUMANOID, LVL(12, 12, 5, 90, -8), (G_GENO | G_HELL | 1),
        ...
        M1_HUMANOID | M1_FLY | M1_SEE_INVIS | M1_OMNIVORE | M1_BREATHLESS
            | M1_REGEN,
        M2_HOSTILE | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_COLLECT,
        M3_INFRAVISION, MH_UNDEAD, 16, CLR_MAGENTA),
    ...
    MON("deeper one", S_HUMANOID, LVL(15, 12, 0, 30, -7),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 18, CLR_BRIGHT_GREEN),
    MON("deepest one", S_HUMANOID, LVL(30, 15, -5, 70, -9), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_STALK | M2_GREEDY | M2_JEWELS | M2_COLLECT | M2_PRINCE
            | M2_STRONG | M2_MAGIC | M2_FLANK,
        M3_INFRAVISIBLE | M3_INFRAVISION, 33, HI_LORD),
    /*
     * imps & other minor demons/devils
     */
    /* Despite their relative unintelligence, manes are tagged as flankers so they
       can help assist molydei. */
    MON("manes", S_IMP, LVL(1, 3, 7, 0, -7),
        ...
        M2_HOSTILE | M2_STALK | M2_FLANK, M3_INFRAVISIBLE | M3_INFRAVISION, 3, CLR_RED),
    ...
    MON("kobold shaman", S_KOBOLD, LVL(2, 6, 6, 10, -4), (G_GENO | 1),
        ...
        SIZ(450, 150, MS_ORC, MZ_SMALL), MR_POISON, 0,
        M1_HUMANOID | M1_POIS | M1_OMNIVORE,
        M2_HOSTILE | M2_MAGIC | M2_SUPPORTER,
    ...
    MON("killer mimic", S_MIMIC, LVL(10, 12, 7, 20, 0), (G_GENO | 2),
        ...
        M1_CLING | M1_BREATHLESS | M1_AMORPHOUS | M1_HIDE | M1_ANIMAL
            | M1_NOEYES | M1_NOHEAD | M1_NOLIMBS | M1_THICK_HIDE
            | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_FLANK, 0, 13, CLR_GREEN),
    /*
     * nymphs
     */
    MON3("meliad", "meliad", "wood nymph", S_NYMPH,
    ...
    MON3("nereid", "naiad", "water nymph", S_NYMPH,
        LVL(3, 12, 9, 20, 0), (G_GENO | 2),
        A(ATTK(AT_CLAW, AD_SITM, 0, 0), ATTK(AT_CLAW, AD_SEDU, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON3("oread", "oread", "mountain nymph", S_NYMPH, LVL(3, 12, 9, 20, 0), (G_GENO | 2),
        A(ATTK(AT_CLAW, AD_SITM, 0, 0), ATTK(AT_CLAW, AD_SEDU, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 300, MS_SEDUCE, MZ_HUMAN), 0, 0, M1_HUMANOID | M1_TPORT,
        M2_HOSTILE | M2_FEMALE | M2_COLLECT, M3_INFRAVISIBLE, 5, CLR_BROWN),
    MON("quickling", S_NYMPH, LVL(3, 30, 10, 20, -10), (G_HELL | G_GENO | 3),
      	A(ATTK(AT_WEAP, AD_PHYS, 1, 2), ATTK(AT_CLAW, AD_SITM, 0, 0),
      	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
      	SIZ(60, 30, MS_LAUGH, MZ_TINY), 0, 0, M1_HUMANOID,
        M2_HOSTILE | M2_GREEDY | M2_NASTY, M3_INFRAVISIBLE, 5, CLR_CYAN),
    MON("yuki-onna", S_NYMPH, LVL(5, 12, 9, 20, 5), (G_GENO | 2),
        A(ATTK(AT_TUCH, AD_COLD, 2, 6), ATTK(AT_TUCH, AD_LOST, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 300, MS_SEDUCE, MZ_HUMAN), 0, 0, M1_HUMANOID | M1_TPORT,
        M2_HOSTILE | M2_FEMALE | M2_COLLECT, M3_INFRAVISIBLE, 7, CLR_WHITE),
     ...
     * quadrupeds
     */
    MON("hedgehog", S_QUADRUPED, LVL(0, 12, 0, 0, 0), (G_GENO | 3),
        A(ATTK(AT_BITE, AD_PHYS, 1, 1), ATTK(AT_NONE, AD_QUIL, 2, 3),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(300, 250, MS_BARK, MZ_SMALL), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_HERBIVORE, M2_PEACEFUL, M3_INFRAVISIBLE,
        2, CLR_YELLOW),
    MON3("cow", "bull", "bovine",
      S_QUADRUPED, LVL(1, 6, 8, 0, 0), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_BUTT, AD_PHYS, 1, 8), ATTK(AT_KICK, AD_PHYS, 2, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 800, MS_MOO, MZ_LARGE), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_HERBIVORE,
        M2_PEACEFUL | M2_DOMESTIC,
        M3_INFRAVISIBLE, 2, HI_DOMESTIC),
    ...
    MON("feral hog", S_QUADRUPED, LVL(2, 12, 7, 0, 0), (G_GENO | 2),
        A(ATTK(AT_BUTT, AD_PHYS, 1, 4), ATTK(AT_BUTT, AD_PHYS, 1, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(200, 100, MS_PIG, MZ_MEDIUM), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_OMNIVORE, M2_HOSTILE | M2_FLANK,
        M3_INFRAVISIBLE, 4, CLR_BRIGHT_MAGENTA),
    MON("rothe", S_QUADRUPED, LVL(2, 9, 7, 0, 0), (G_GENO | G_SGROUP | 4),
        ...
        4, CLR_BROWN),
    MON("llama", S_QUADRUPED, LVL(3, 9, 7, 0, 0), (G_GENO | 2),
        A(ATTK(AT_KICK, AD_PHYS, 2, 4), ATTK(AT_SPIT, AD_ACID, 1, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 100, MS_SILENT, MZ_LARGE), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_HERBIVORE,
        M2_DOMESTIC, M3_INFRAVISIBLE, 4, HI_DOMESTIC),
    MON("black bear", S_QUADRUPED, LVL(4, 12, 7, 0, 0), (G_GENO | 2),
        ...
        5, CLR_BLACK),
    MON2("werebear", S_QUADRUPED, LVL(4, 12, 7, 0, 0), (G_GENO | G_NOCORPSE),
        ...
        M2_NOPOLY | M2_STRONG | M2_PEACEFUL, M3_INFRAVISIBLE, MH_WERE,
        7, CLR_BLACK),
    ...
    MON("landshark", S_QUADRUPED, LVL(7, 12, 2, 0, 0), (G_GENO | 2),
        ...
        M2_HOSTILE | M2_STRONG | M2_JUMPER, 0, 9, CLR_GRAY),
    ...
    MON("chimera", S_QUADRUPED, LVL(10, 12, 4, 20, -1), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 1, 10), ATTK(AT_BITE, AD_DRST, 2, 4),
          ATTK(AT_BUTT, AD_PHYS, 3, 4), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2500, 500, MS_CHIMERA, MZ_LARGE), MR_FIRE, MR_FIRE,
        M1_FLY | M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE, M2_HOSTILE | M2_STRONG |
        M2_NASTY, M3_INFRAVISIBLE, 12, CLR_GREEN),
    /* Grizzly bears are always hostile because come on--They're grizzlies. */
    MON("grizzly bear", S_QUADRUPED, LVL(12, 12, 7, 0, 0), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 3, 8), ATTK(AT_CLAW, AD_PHYS, 2, 3),
          ATTK(AT_CLAW, AD_PHYS, 1, 3), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(700, 300, MS_ROAR, MZ_LARGE), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_OMNIVORE,
        M2_STRONG | M2_HOSTILE, M3_INFRAVISIBLE,
        5, CLR_YELLOW),
    MON("hippo", S_QUADRUPED, LVL(10, 3, 2, 0, 0), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_BITE, AD_PHYS, 8, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(2600, 500, MS_YAWN, MZ_LARGE), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_OMNIVORE | M1_SWIM,
        M2_HOSTILE | M2_STRONG | M2_WANDER | M2_FLANK, M3_INFRAVISIBLE,
        12, CLR_BRIGHT_CYAN),
    ...
    MON("hellbear", S_QUADRUPED, LVL(16, 13, 5, 0, -1),
        ...
        M2_HOSTILE | M2_STRONG, M3_INFRAVISIBLE, 18, CLR_RED),
    ...
    MON("pack rat", S_RODENT, LVL(2, 12, 7, 0, 0), (G_GENO | 1),
        ...
        SIZ(30, 30, MS_SQEEK, MZ_TINY), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE,
        M2_HOSTILE | M2_COLLECT | M2_STRONG | M2_FLANK, M3_INFRAVISIBLE, 3, CLR_YELLOW),
    MON2("wererat", S_RODENT, LVL(2, 12, 6, 10, -7), (G_NOGEN | G_NOCORPSE),
        A(ATTK(AT_BITE, AD_WERE, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("ratman", S_RODENT, LVL(2, 12, 8, 0, -3), (G_GENO | G_LGROUP | 1),
        ...
        M2_STALK | M2_GREEDY | M2_COLLECT | M2_FLANK,
        M3_INFRAVISIBLE | M3_INFRAVISION, 4, CLR_GREEN),
    MON("ratman squeaker", S_RODENT, LVL(3, 12, 7, 0, -5), (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 3), ATTK(AT_BITE, AD_PHYS, 1, 2),
          ATTK(AT_HUGS, AD_PHYS, 1, 2), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(800, 100, MS_SQEEK, MZ_HUMAN), MR_POISON, 0,
            M1_HUMANOID | M1_CARNIVORE | M1_SWIM,
        M2_STALK | M2_GREEDY | M2_COLLECT | M2_SUPPORTER,
        M3_INFRAVISIBLE | M3_INFRAVISION, 5, CLR_BRIGHT_GREEN),
    MON("hellrat", S_RODENT, LVL(5, 15, 7, 0, 0),
        (G_HELL | G_GENO | G_LGROUP | G_NOCORPSE | 3),
      	...
      	M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE,
      	M2_HOSTILE, M3_INFRAVISIBLE, 7, CLR_RED),
    MON3("rat king", "rat queen", "rat ruler",
        ...
        M2_MAGIC | M2_FLANK, M3_INFRAVISIBLE, 16, HI_LORD),
    /*
    ...
    MON("jumping spider", S_SPIDER, LVL(6, 15, 4, 0, 0), (G_GENO | 1),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_OVIPAROUS | M1_POIS | M1_CARNIVORE
            | M1_CONCEAL,
        M2_HOSTILE | M2_STRONG | M2_JUMPER, 0, 8, CLR_BLUE),
    MON("monstrous spider", S_SPIDER, LVL(8, 15, 4, 0, 0), (G_GENO | 1),
        ...
        M1_ANIMAL | M1_NOHANDS | M1_OVIPAROUS | M1_POIS | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG, 0, 10, CLR_ORANGE),
    /*
     * trappers, lurkers, &c
     */
    ...
    MON("selkie", S_UNICORN, LVL(11, 24, 4, 0, 0), (G_GENO | 1),
        ...
        13, CLR_GREEN),
    MON2("nightmare", S_UNICORN, LVL(10, 24, 4, 0, -3), (G_HELL | G_GENO | 2),
    ...
    MON2("white horse", S_UNICORN, LVL(18, 24, 0, 70, 0), (G_NOGEN | G_NOCORPSE),
        A(ATTK(AT_KICK, AD_PHYS, 2, 8), ATTK(AT_KICK, AD_PHYS, 2, 8),
     ...
     * worms
     */
    MON("maggot", S_WORM, LVL(1, 9, 5, 0, 0), (G_NOGEN | G_NOCORPSE),
         ...
         M1_ANIMAL | M1_SLITHY | M1_NOLIMBS | M1_CARNIVORE | M1_NOTAKE
            | M1_POIS,
         M2_HOSTILE, MH_UNDEAD, 1, CLR_GREEN),
    ...
    MON("will-o'-the-wisp", S_LIGHT, LVL(2, 9, 2, 0, 0),
        ...
        A(ATTK(AT_TUCH, AD_BLND, 1, 2), ATTK(AT_TUCH, AD_ELEC, 1, 1),
            NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        ...
        M2_HOSTILE | M2_NEUTER | M2_WANDER, M3_INFRAVISIBLE, 4, CLR_WHITE),
    ...
    MON("lamassu", S_ANGEL, LVL(12, 12, -3, 50, 0), (G_NOHELL | G_NOCORPSE | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 16, CLR_BROWN),
    MON("movanic deva", S_ANGEL, LVL(12, 18, -5, 90, 15),
        ...
        M2_NOPOLY | M2_MINION | M2_STALK | M2_STRONG | M2_NASTY,
	      M3_INFRAVISIBLE | M3_INFRAVISION, 21, CLR_BLUE),
    MON("monadic deva", S_ANGEL, LVL(15, 18, -4, 90, 15),
        (G_PLANES | G_NOCORPSE | 1),
      	...
      	M1_FLY | M1_HUMANOID | M1_SEE_INVIS,
      	M2_NOPOLY | M2_MINION | M2_STALK | M2_STRONG | M2_NASTY,
	      M3_INFRAVISIBLE | M3_INFRAVISION, 23, CLR_BRIGHT_CYAN),
    MON("astral deva", S_ANGEL, LVL(18, 18, -6, 90, 15),
        ...
        M1_FLY | M1_HUMANOID | M1_SEE_INVIS,
        M2_NOPOLY | M2_MINION | M2_STALK | M2_STRONG | M2_NASTY,
        M3_INFRAVISIBLE | M3_INFRAVISION, 27, CLR_WHITE),
    ...
    MON("Herald Archon", S_ANGEL, LVL(17, 16, -6, 50, 15),
        ...
        M2_NOPOLY | M2_MINION | M2_STALK | M2_STRONG | M2_NASTY
            | M2_COLLECT | M2_MAGIC | M2_FLANK,
        M3_INFRAVISIBLE | M3_INFRAVISION, 24, CLR_CYAN),
    MON("Hearth Archon", S_ANGEL, LVL(18, 18, -4, 55, 0),
        (G_NOHELL | G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6),
        ...
        M2_MAGIC | M2_SUPPORTER,
        M3_INFRAVISIBLE | M3_INFRAVISION, 23, CLR_ORANGE),
    MON("Throne Archon", S_ANGEL, LVL(19, 16, -6, 80, 15),
        (G_NOHELL | G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),
    ...
    MON("Planetar", S_ANGEL, LVL(29, 16, -10, 80, 15),
        ...
        M2_NOPOLY | M2_MINION | M2_STALK | M2_STRONG | M2_NASTY | M2_LORD |
        M2_COLLECT | M2_MAGIC | M2_FLANK, M3_INFRAVISIBLE | M3_INFRAVISION,
        38, HI_LORD),
    ...
    MON("zoo bat", S_BAT, LVL(3, 20, 7, 0, 0), (G_GENO | G_LGROUP | 3),
        ...
        SIZ(30, 30, MS_SQEEK, MZ_SMALL), 0, 0,
        M1_FLY | M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE,
        M2_WANDER | M2_HOSTILE | M2_FLANK, M3_INFRAVISIBLE, 5, CLR_CYAN),
    ...
    MON("parrot", S_BAT, LVL(2, 20, 6, 0, 0), (G_GENO | 2),
        ...
        M2_WANDER | M2_HOSTILE, M3_INFRAVISIBLE, 4, CLR_GREEN),
    ...
    MON("gaol bat", S_BAT, LVL(8, 20, 6, 0, 0), (G_GENO | G_HELL | G_SGROUP | 2),
        ...
        M2_HOSTILE | M2_FLANK, M3_INFRAVISIBLE, 9, HI_GOLD),
    ...
    MON("mountain centaur", S_CENTAUR, LVL(6, 20, 2, 10, -3), (G_GENO | 1),
        ...
        M2_STRONG | M2_GREEDY | M2_COLLECT | M2_FLANK,
    ...
    MON("baby violet dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("orange dragon", S_DRAGON, LVL(15, 9, -1, 20, 5), (G_GENO | 1),
        ...
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        0, 20, CLR_ORANGE),
    MON("violet dragon", S_DRAGON, LVL(15, 9, -1, 20, -5), (G_GENO | 1),
    ...
    MON("razor dragon", S_DRAGON, LVL(25, 18, -10, 20, 7), (G_GENO | G_PLANES | 1),
        ...
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_SEE_INVIS
            | M1_METALLIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC | M2_FLANK,
        0, 29, CLR_CYAN),
    ...
    MON("void dragon", S_DRAGON, LVL(25, 9, -10, 20, 0),
        ...
        M2_NOPOLY,
        0, 31, HI_LORD),
    MON("Sharur", S_DRAGON, LVL(12, 15, -3, 50, 0), (G_NOGEN | G_UNIQ | G_NOCORPSE),
        A(ATTK(AT_CLAW, AD_PHYS, 4, 4), ATTK(AT_CLAW, AD_PHYS, 4, 4),
          ATTK(AT_BITE, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 300, MS_GROWL, MZ_LARGE), MR_FIRE, MR_FIRE,
        M1_ANIMAL | M1_SEE_INVIS | M1_CARNIVORE | M1_FLY,
        M2_STALK | M2_NASTY | M2_STRONG | M2_MALE | M2_PNAME | M2_NOPOLY,
        M3_INFRAVISIBLE | M3_INFRAVISION, 16, CLR_BROWN),
    /*
     * Elementals
     */
    ...
    MON("acid elemental", S_ELEMENTAL, LVL(8, 6, 2, 30, 0), (G_NOCORPSE | G_NOGEN),
        ...
        M2_STRONG | M2_NEUTER, 0, 12, CLR_BRIGHT_GREEN),
    MON("ice elemental", S_ELEMENTAL, LVL(8, 12, 2, 30, 0), (G_NOCORPSE | G_NOGEN),
        ...
        M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS | M1_BREATHLESS
            | M1_UNSOLID | M1_AMPHIBIOUS | M1_SWIM,
        M2_STRONG | M2_NEUTER, 0, 12, CLR_WHITE),
    MON("magma elemental", S_ELEMENTAL, LVL(8, 6, 2, 30, 0), (G_NOCORPSE | G_HELL),
        ...
        M2_STRONG | M2_NEUTER, M3_INFRAVISIBLE, 12, CLR_ORANGE),
    MON("plasma elemental", S_ELEMENTAL, LVL(8, 36, 2, 30, 0), (G_NOCORPSE | G_NOGEN),
        A(ATTK(AT_CLAW, AD_FIRE, 2, 6), ATTK(AT_ENGL, AD_ELEC, 1, 10),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(0, 0, MS_SILENT, MZ_HUGE), MR_POISON | MR_STONE | MR_FIRE | MR_ELEC, 0,
        M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS | M1_BREATHLESS
            | M1_UNSOLID | M1_FLY,
        M2_STRONG | M2_NEUTER, 0, 14, CLR_CYAN),
    MON("fusion elemental", S_ELEMENTAL, LVL(25, 18, 2, 30, 0),
        ...
        M2_STRONG | M2_NEUTER, 0, 28, CLR_MAGENTA),
    /*
     * Fungi
     */
    ...
    MON("volatile mushroom", S_FUNGUS, LVL(1, 0, 9, 0, 0),
        ...
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_POIS | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, 0, 3, CLR_ORANGE),
    ...
    MON("shrieker", S_FUNGUS, LVL(3, 1, 7, 0, 0), (G_GENO | 1),
        NO_ATTKS, SIZ(100, 100, MS_SHRIEK, MZ_SMALL), MR_POISON, MR_POISON,
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
    ...
    MON("screamer", S_FUNGUS, LVL(4, 4, 7, 0, 0), (G_GENO | 1),
        ...
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
        M2_HOSTILE | M2_NEUTER, 0, 5, CLR_BRIGHT_MAGENTA),
    MON("brown moldier", S_FUNGUS, LVL(5, 12, 8, 0, 0),
        (G_GENO | 1),
        ...
        M2_STALK | M2_NEUTER | M2_HOSTILE, 0, 7, CLR_BROWN),
    MON("yellow moldier", S_FUNGUS, LVL(5, 12, 8, 0, 0),
        (G_GENO | 1),
        ...
        M1_BREATHLESS | M1_HUMANOID | M1_NOEYES,
        M2_STALK | M2_NEUTER | M2_HOSTILE, 0, 7, CLR_YELLOW),
    MON("green moldier", S_FUNGUS, LVL(5, 12, 8, 0, 0),
        (G_GENO | 1),
        ...
        M1_BREATHLESS | M1_HUMANOID | M1_NOEYES,
        M2_STALK | M2_NEUTER | M2_HOSTILE, 0, 7, CLR_GREEN),
    MON("red moldier", S_FUNGUS, LVL(5, 12, 8, 0, 0),
        (G_GENO | 1),
        ...
        M1_BREATHLESS | M1_HUMANOID | M1_NOEYES,
        M2_STALK | M2_NEUTER | M2_HOSTILE, M3_INFRAVISIBLE, 7, CLR_RED),
    /*
     * Gnomes
     */
    MON2("gnome", S_GNOME, LVL(1, 6, 10, 4, 0), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(650, 100, MS_ORC, MZ_SMALL), 0, 0, M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_COLLECT, M3_INFRAVISIBLE | M3_INFRAVISION, MH_GNOME,
        3, CLR_BROWN),
    MON4("gnome lord", "gnome lady", "gnome leader",
    ...
    MON2("gnomish wizard", S_GNOME, LVL(3, 10, 4, 10, 0), (G_GENO | 1),
        A(ATTK(AT_MAGC, AD_SPEL, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(700, 120, MS_ORC, MZ_SMALL), 0, 0, M1_HUMANOID | M1_OMNIVORE,
        M2_MAGIC, M3_INFRAVISIBLE | M3_INFRAVISION, MH_GNOME, 5, HI_ZAP),
    MON2("gnomish psyker", S_GNOME, LVL(3, 10, 4, 10, 0), (G_GENO | 1),
        ...
        CLR_BRIGHT_MAGENTA),
    MON4("gnome king", "gnome queen", "gnome ruler",
    ...
    */
    MON("gnoll", S_GNOLL,
      	...
      	A(ATTK(AT_WEAP, AD_PHYS, 3, 6),  ATTK(AT_WEAP, AD_PHYS, 3, 6),
      	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
      	SIZ(1800, 100, MS_GNOLL, MZ_HUMAN), 0, 0,
    ...
    MON("gnoll shaman", S_GNOLL,
      	...
      	SIZ(1800, 100, MS_GNOLL, MZ_HUMAN), 0, 0,
      	M1_HIDE | M1_HUMANOID | M1_POIS | M1_SEE_INVIS | M1_OMNIVORE,
      	M2_NOPOLY | M2_HOSTILE | M2_COLLECT | M2_MAGIC | M2_GREEDY | M2_JEWELS | M2_SUPPORTER,
    ...
    MON("marrashi", S_GNOLL,
      	...
      	SIZ(2200, 100, MS_GNOLL, MZ_HUMAN), 0, 0,
...
struct permonst _mons2[] = {
     ...
     * giant Humanoids
     */
    MON4("giant", "giantess", "giant",
        S_GIANT, LVL(6, 6, 0, 0, 2), (G_GENO | G_NOGEN | 1),
        A(ATTK(AT_WEAP, AD_CLOB, 2, 10), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(2250, 750, MS_BOAST, MZ_HUGE), 0, 0, M1_HUMANOID | M1_CARNIVORE,
        M2_STRONG | M2_ROCKTHROW | M2_NASTY | M2_COLLECT
            | M2_JEWELS,
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_GIANT, 8, CLR_RED),
    MON4("stone giant", "stone giantess", "stone giant",
        S_GIANT, LVL(6, 6, 0, 0, 2), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_WEAP, AD_CLOB, 2, 10), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(2250, 750, MS_BOAST, MZ_HUGE), 0, 0, M1_HUMANOID | M1_CARNIVORE,
        M2_STRONG | M2_ROCKTHROW | M2_NASTY | M2_COLLECT
    ...
    MON4("hill giant", "hill giantess", "hill giant",
        S_GIANT, LVL(8, 10, 6, 0, -2), (G_GENO | G_SGROUP | 1),
    ...
    MON4("fire giant", "fire giantess", "fire giant",
        S_GIANT, LVL(9, 12, 4, 5, 2), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_WEAP, AD_CLOB, 2, 10), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON4("frost giant", "frost giantess", "frost giant",
        S_GIANT, LVL(10, 12, 3, 10, -3),
        (G_NOHELL | G_GENO | G_SGROUP | 1),
    ...
    MON4("storm giant", "storm giantess", "storm giant",
        S_GIANT, LVL(16, 12, 3, 10, -3),
    ...
    MON("hecatoncheire", S_GIANT, LVL(20, 9, -5, 60, 5), (G_GENO | 1),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, 27, CLR_MAGENTA),
    /*
     * Invisible
     ...
     * Kops
     */
    MON2("Keystone Kop", S_KOP, LVL(1, 6, 10, 10, 9),
    ...
    MON2("Kop Sergeant", S_KOP, LVL(2, 8, 10, 10, 10),
    ...
    MON2("Korrupt Kop", S_KOP, LVL(3, 10, 10, 20, 11), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 200, MS_ARREST, MZ_HUMAN), 0, 0, M1_HUMANOID,
        M2_WANDER | M2_HOSTILE | M2_STRONG | M2_MALE | M2_COLLECT | M2_FLANK,
        M3_INFRAVISIBLE, MH_HUMAN, 5, CLR_CYAN),
    MON2("Kop Lieutenant", S_KOP, LVL(3, 10, 10, 20, 11), (G_GENO | G_NOGEN),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 200, MS_ARREST, MZ_HUMAN), 0, 0, M1_HUMANOID,
        M2_WANDER | M2_HOSTILE | M2_STRONG | M2_MALE | M2_COLLECT | M2_FLANK,
        M3_INFRAVISIBLE, MH_HUMAN, 5, CLR_CYAN),
    MON2("Kop Kaptain", S_KOP, LVL(4, 12, 10, 20, 12), (G_GENO | G_NOGEN),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 200, MS_ARREST, MZ_HUMAN), 0, 0, M1_HUMANOID,
        M2_WANDER | M2_HOSTILE | M2_STRONG | M2_MALE | M2_COLLECT | M2_FLANK,
     ...
     * Liches
     */
    MON2("worm that walks", S_LICH, LVL(11, 6, 0, 30, -9),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_DRCO, 1, 10), ATTK(AT_MAGC, AD_SPEL, 0, 0), NO_ATTK,
        NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON2("lich", S_LICH, LVL(11, 6, 0, 30, -9), (G_GENO | G_NOCORPSE | 1),
    ...
    MON2("demilich", S_LICH, LVL(14, 9, -2, 60, -12),
        (G_GENO | G_NOCORPSE | 1),
    ...
    MON2("eye of fear and flame", S_LICH, LVL(16, 9, -4, 70, -13),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_GAZE, AD_FEAR, 0, 4), ATTK(AT_GAZE, AD_FIRE, 4, 4),
          ATTK(AT_MAGC, AD_SPEL, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1200, 100, MS_MUMBLE, MZ_HUMAN),
        MR_COLD | MR_FIRE | MR_SLEEP | MR_POISON,
        MR_COLD, M1_BREATHLESS | M1_HUMANOID | M1_POIS | M1_REGEN,
        M2_HOSTILE | M2_MAGIC, M3_INFRAVISION, MH_UNDEAD, 18, CLR_ORANGE),
    MON2("master lich", S_LICH, LVL(17, 9, -4, 90, -15),
        (G_HELL | G_GENO | G_NOCORPSE | 1),
        ...
        MH_UNDEAD, 21, HI_LORD),
    MON2("arch-lich", S_LICH, LVL(25, 9, -6, 90, -15),
        (G_HELL | G_GENO | G_NOCORPSE | 1),
        ...
        M1_BREATHLESS | M1_HUMANOID | M1_POIS | M1_REGEN,
        M2_HOSTILE | M2_MAGIC, M3_WANTSBOOK | M3_INFRAVISION,
        MH_UNDEAD, 29, HI_LORD),
    /*
     * Mummies
     */
    MON2("kobold mummy", S_MUMMY, LVL(3, 8, 6, 20, -2),
    ...
    MON2("gnome mummy", S_MUMMY, LVL(4, 10, 6, 20, -3),
    ...
    MON2("orc mummy", S_MUMMY, LVL(5, 10, 5, 20, -4),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_WTHR, 1, 6), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON2("dwarf mummy", S_MUMMY, LVL(5, 10, 5, 20, -4),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_WTHR, 1, 6), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON2("elf mummy", S_MUMMY, LVL(6, 12, 4, 30, -5),
    ...
    MON2("human mummy", S_MUMMY, LVL(6, 12, 4, 30, -5),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_WTHR, 2, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 200, MS_SILENT, MZ_HUMAN),
        MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_HOSTILE, M3_INFRAVISION, MH_UNDEAD, 7, CLR_GRAY),
    MON2("ettin mummy", S_MUMMY, LVL(7, 12, 4, 30, -6),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 6), ATTK(AT_CLAW, AD_WTHR, 2, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1700, 250, MS_SILENT, MZ_HUGE), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_HOSTILE | M2_STRONG, M3_INFRAVISION, MH_UNDEAD, 8, CLR_BLUE),
    MON2("adherer", S_MUMMY, LVL(7, 12, 4, 30, -5),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_STCK, 2, 4), ATTK(AT_CLAW, AD_WTHR, 2, 4),
          ATTK(AT_NONE, AD_DSRM, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 200, MS_SILENT, MZ_HUMAN),
        MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_HOSTILE, M3_INFRAVISION, MH_UNDEAD, 9, CLR_YELLOW),
    MON4("giant mummy", "giantess mummy", "giant mummy",
        S_MUMMY, LVL(8, 14, 3, 30, -7),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_CLOB, 3, 4), ATTK(AT_CLAW, AD_WTHR, 3, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("ogre mage", S_OGRE, LVL(7, 12, 3, 30, -5), (G_NOHELL | G_GENO | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), ATTK(AT_MAGC, AD_SPEL, 0, 0),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1700, 700, MS_GRUNT, MZ_LARGE), 0, 0, M1_HUMANOID | M1_CARNIVORE,
        M2_STRONG | M2_LORD | M2_GREEDY | M2_JEWELS | M2_COLLECT | M2_SUPPORTER,
    ...
    MON("blood pudding", S_PUDDING, LVL(7, 5, 4, 0, 0),
        ...
        M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_MINDLESS | M1_OMNIVORE | M1_ACID,
        M2_HOSTILE | M2_NEUTER | M2_NASTY, 0, 9, CLR_RED),
    MON("gel", S_PUDDING, LVL(7, 5, 4, 0, 0),
        ...
        M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_MINDLESS | M1_OMNIVORE | M1_ACID,
        M2_HOSTILE | M2_NEUTER | M2_NASTY, 0, 9, CLR_BRIGHT_CYAN),
    /*
     * Quantum mechanics
     */
    ...
    MON("alchemist", S_QUANTMECH, LVL(9, 12, 3, 10, 0), (G_GENO | 3),
    ...
    MON("transmuter", S_RUSTMONST, LVL(12, 12, 2, 0, 3),
        ...
        | M1_OMNIVORE, M2_HOSTILE, M3_INFRAVISIBLE, 14, CLR_BRIGHT_CYAN),
    ...
    MON("cerastes", S_SNAKE, LVL(7, 0, 15, 10, 0), (G_GENO | 2),
        ...
        SIZ(600, 250, MS_SILENT, MZ_LARGE), 0, 0,
        M1_ANIMAL | M1_SLITHY | M1_NOLIMBS | M1_CARNIVORE | M1_NOTAKE |
        M1_CONCEAL, M2_HOSTILE, 0, 8, CLR_YELLOW),
    MON("amphisbaena", S_SNAKE, LVL(9, 12, 5, 0, -3), (G_GENO | 2),
        ...
        M1_SWIM | M1_NOLIMBS | M1_ANIMAL | M1_SLITHY | M1_CARNIVORE
            | M1_OVIPAROUS | M1_NOTAKE,
        M2_HOSTILE | M2_STRONG | M2_FLANK, M3_INFRAVISION, 13, CLR_ORANGE),
    /*
     * Trolls
     */
    ...
    MON("water troll", S_TROLL, LVL(11, 14, 4, 40, -3), (G_NOGEN | G_GENO),
        ...
        M2_STRONG | M2_STALK | M2_HOSTILE, M3_INFRAVISIBLE | M3_INFRAVISION,
        13, CLR_BLUE),
    MON2("grave troll", S_TROLL, LVL(11, 8, 0, 60, 0), (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 6), ATTK(AT_CLAW, AD_PHYS, 2, 6),
    ...
    MON("shambling horror", S_UMBER,
        ...
        NO_ATTKS, SIZ(25, 25, MS_SILENT, MZ_TINY), 0, 0,
        M1_CARNIVORE, 0, M3_INFRAVISIBLE, 11, DRAGON_SILVER),
    /*
     * Vampires
     */
    MON2("baobhan-sith", S_VAMPIRE, LVL(10, 12, 1, 25, -8),
    ...
    MON2("vampire", S_VAMPIRE, LVL(10, 12, 1, 25, -8),
        (G_GENO | G_NOCORPSE | 1),
    ...
    MON4("vampire lord", "vampire lady", "vampire leader",
    ...
    MON2("nosferatu", S_VAMPIRE, LVL(20, 14, -4, 50, -9),
        (G_GENO | G_NOCORPSE | 1),
      	A(ATTK(AT_CLAW, AD_DRLI, 2, 8), ATTK(AT_BITE, AD_DRLI, 1, 8),
      	...
      	M1_FLY | M1_BREATHLESS | M1_HUMANOID | M1_POIS | M1_REGEN,
      	M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY | M2_LORD
          | M2_MALE | M2_MAGIC | M2_FLANK, M3_INFRAVISIBLE,
        MH_UNDEAD, 25, CLR_GRAY),
    MON2("Alucard", S_VAMPIRE, LVL(24, 20, -6, 70, -10),
        ...
        M2_NOPOLY | M2_STALK | M2_HOSTILE | M2_PNAME | M2_STRONG
            | M2_NASTY | M2_PRINCE | M2_MALE | M2_SHAPESHIFTER | M2_FLANK,
        M3_WAITFORU | M3_INFRAVISIBLE,
        MH_UNDEAD, 29, HI_LORD),
    MON2("Vlad the Impaler", S_VAMPIRE, LVL(28, 26, -6, 80, -10),
        (G_NOGEN | G_NOCORPSE | G_UNIQ),
     ...
     * Wraiths
     */
    MON2("barrow wight", S_WRAITH, LVL(3, 12, 5, 5, -3),
        (G_GENO | G_NOCORPSE | 1),
        ...
        M2_STALK | M2_HOSTILE | M2_COLLECT, 0, MH_UNDEAD, 8, CLR_GRAY),
    MON2("bodak", S_WRAITH, LVL(8, 12, 6, 10, 0),
        (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_DRLI, 1, 6), ATTK(AT_GAZE, AD_FEAR, 0, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(800, 0, MS_MUMBLE, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_HUMANOID,
        M2_STALK | M2_NASTY | M2_WANDER | M2_COLLECT, M3_INFRAVISION,
        MH_UNDEAD, 10, CLR_YELLOW),
    MON2("wraith", S_WRAITH, LVL(6, 12, 4, 15, -6), (G_GENO | 2),
    ...
    MON2("Nazgul", S_WRAITH, LVL(13, 12, 0, 25, -17),
        (G_GENO | G_NOCORPSE | 1),
    ...
    MON2("banshee", S_WRAITH, LVL(15, 10, 10, 0, 5), (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_TUCH, AD_PHYS, 2, 6), ATTK(AT_TUCH, AD_PHYS, 2, 6),
          ATTK(AT_SCRE, AD_FEAR, 3, 6), NO_ATTK, NO_ATTK, NO_ATTK),
     ...
     * Zombies
     */
    MON2("kobold zombie", S_ZOMBIE, LVL(0, 6, 10, 0, -2),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 4), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 50, MS_SILENT, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_STALK | M2_HOSTILE | M2_FLANK, M3_INFRAVISION, MH_UNDEAD, 1, CLR_BROWN),
    MON2("gnome zombie", S_ZOMBIE, LVL(1, 6, 10, 0, -2),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 5), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(650, 50, MS_SILENT, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_STALK | M2_HOSTILE, M3_INFRAVISION,
        MH_GNOME | MH_UNDEAD, 2, CLR_BROWN),
    MON2("orc zombie", S_ZOMBIE, LVL(2, 6, 9, 0, -3),
        ...
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_STALK | M2_HOSTILE, M3_INFRAVISION,
        MH_ORC | MH_UNDEAD, 3, CLR_GRAY),
    MON2("dwarf zombie", S_ZOMBIE, LVL(2, 6, 9, 0, -3),
        (G_GENO | G_SGROUP | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(900, 150, MS_SILENT, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
        M2_STALK | M2_HOSTILE, M3_INFRAVISION,
        MH_DWARF | MH_UNDEAD, 3, CLR_RED),
    MON2("elf zombie", S_ZOMBIE, LVL(3, 6, 9, 0, -3),
        (G_GENO | G_SGROUP | G_NOCORPSE | 1),
        ...
        4, CLR_GREEN),
    MON2("human zombie", S_ZOMBIE, LVL(4, 6, 8, 0, -3),
        (G_GENO | G_SGROUP | G_NOCORPSE | 1),
    ...
    MON2("draugr", S_ZOMBIE, LVL(5, 12, 8, 0, -3),
        ...
        M3_INFRAVISION, MH_UNDEAD, 7, CLR_BLUE),
    MON2("ettin zombie", S_ZOMBIE, LVL(6, 8, 6, 0, -4),
        (G_GENO | G_NOCORPSE | 1),
    ...
    MON2("ghoul", S_ZOMBIE, LVL(3, 6, 10, 0, -2), (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PLYS, 1, 2), ATTK(AT_CLAW, AD_PHYS, 1, 3), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 50, MS_SILENT, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS | M1_OMNIVORE,
        M2_WANDER | M2_HOSTILE, M3_INFRAVISION, MH_UNDEAD, 5, CLR_BLACK),
    MON2("vomitous ghoul", S_ZOMBIE, LVL(4, 6, 10, 0, -2),
        (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PLYS, 1, 2), ATTK(AT_CLAW, AD_PHYS, 1, 3),
          ATTK(AT_SPIT, AD_ACID, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 50, MS_SILENT, MZ_SMALL), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS | M1_OMNIVORE,
        M2_WANDER | M2_HOSTILE, M3_INFRAVISION, MH_UNDEAD,
        6, CLR_BLACK),
    MON2("skeletal pirate", S_ZOMBIE, LVL(5, 8, 4, 0, 0),
    ...
    MON4("giant zombie", "giantess zombie", "giant zombie",
        S_ZOMBIE, LVL(8, 8, 6, 0, -4),
        (G_GENO | G_NOCORPSE | 1),
    ...
    MON2("ghast", S_ZOMBIE,  LVL(4, 6, 10, 0, -2), (G_GENO | G_NOCORPSE | 1),
      	...
      	M2_STALK | M2_HOSTILE | M2_FLANK, 0, MH_UNDEAD, 6, CLR_BLACK),
    MON2("ghoul mage", S_ZOMBIE, LVL(10, 12, 4, 10, -4),
        (G_GENO | G_NOCORPSE | 1),
    ...
    MON2("skeleton", S_ZOMBIE, LVL(12, 8, 4, 0, 0), (G_NOCORPSE | G_NOGEN),
    ...
    MON2("zombie dragon", S_ZOMBIE, LVL(14, 8, -1, 20, -4), (G_GENO | 1),
    ...
    MON2("bonewalker", S_ZOMBIE, LVL(20, 15, 4, 0, 0),
        (G_NOCORPSE | G_GENO | 1),
    ...
    MON("wax golem", S_GOLEM, LVL(3, 12, 9, 0, 0), (G_NOCORPSE | 1),
    	...
    	M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID,
    	M2_HOSTILE | M2_NEUTER, M3_INFRAVISIBLE, 5, CLR_GRAY),
    ...
    MON("silver golem", S_GOLEM, LVL(18, 8, 1, 50, 0), (G_NOCORPSE | 1),
        ...
        SIZ(1800, 0, MS_SILENT, MZ_LARGE), MR_SLEEP | MR_POISON | MR_ACID, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE,
        M2_HOSTILE | M2_STRONG, 0, 20, CLR_BRIGHT_CYAN),
    ...
    MON("ruby golem", S_GOLEM, LVL(24, 12, 3, 60, 0), (G_NOCORPSE | 1),
      	...
      	MR_FIRE | MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON, 0,
      	M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE | M1_POIS,
      	M2_HOSTILE | M2_STRONG | M2_COLLECT | M2_NEUTER, 0, 28, CLR_RED),
    MON("sapphire golem", S_GOLEM, LVL(28, 12, 3, 60, 0), (G_NOCORPSE | 1),
      	...
      	MR_FIRE | MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON, 0,
      	M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE | M1_POIS,
      	M2_HOSTILE | M2_STRONG | M2_COLLECT | M2_NEUTER, 0, 32,
        CLR_BRIGHT_CYAN),
    MON("steel golem", S_GOLEM, LVL(30, 15, 3, 60, 0), (G_NOCORPSE | 1),
      	...
      	MR_FIRE | MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON, 0,
      	M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE | M1_POIS,
      	M2_HOSTILE | M2_STRONG | M2_COLLECT | M2_NEUTER, 0, 34,
        CLR_BRIGHT_BLUE),
    MON("crystal golem", S_GOLEM, LVL(32, 15, 3, 60, 0), (G_NOCORPSE | 1),
      	...
      	MR_FIRE | MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON, 0,
      	M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE | M1_POIS,
      	M2_HOSTILE | M2_STRONG | M2_COLLECT | M2_NEUTER, 0, 36,
        CLR_BRIGHT_BLUE),
    /*
     * humans, including elves and were-critters;
     *  the '@' class does not obey rule #2.
     */
    MON2("human", S_HUMAN, LVL(0, 12, 10, 0, 0), G_NOGEN, /* for corpses */
    ...
    MON2("prison guard", S_HUMAN,
        ...
        M2_NOPOLY | M2_MERC | M2_STALK | M2_HOSTILE | M2_STRONG | M2_COLLECT
          | M2_FLANK,
        M3_INFRAVISIBLE, MH_HUMAN, 14, HI_METAL),
    MON2("wererat", S_HUMAN, LVL(2, 12, 10, 10, -7), (1),
    ...
    MON2("werejackal", S_HUMAN, LVL(2, 12, 10, 10, -7), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_WERE, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_POIS | M1_REGEN | M1_OMNIVORE,
    ...
    MON2("martial artist", S_HUMAN, LVL(6, 12, 5, 20, 0), (2),
        A(ATTK(AT_CLAW, AD_DSRM, 1, 6), ATTK(AT_KICK, AD_PHYS, 1, 4),
          ATTK(AT_KICK, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_COLLECT | M2_HOSTILE | M2_FLANK,
        M3_INFRAVISIBLE, MH_HUMAN, 8, CLR_YELLOW),
    MON2("weretiger", S_HUMAN, LVL(7, 12, 10, 20, -7), (G_NOGEN),
    ...
    MON2("grandmaster", S_HUMAN, LVL(9, 12, 2, 20, 0), (2),
        A(ATTK(AT_CLAW, AD_DSRM, 1, 8), ATTK(AT_KICK, AD_STUN, 1, 8),
          ATTK(AT_KICK, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_HOSTILE | M2_FLANK, M3_INFRAVISIBLE,
    ...
    MON2("werebear", S_HUMAN, LVL(5, 12, 10, 20, 5), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_WERE, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_POIS | M1_REGEN | M1_OMNIVORE,
    ...
    MON2("elf", S_HUMAN, LVL(0, 12, 10, 2, -3), G_NOGEN, /* for corpses */
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS,
        M2_NOPOLY | M2_STRONG | M2_COLLECT,
        M3_INFRAVISION | M3_INFRAVISIBLE, MH_ELF, 2, HI_DOMESTIC),
    MON2("Woodland-elf", S_HUMAN, LVL(4, 12, 10, 10, -5),
        (G_GENO | G_SGROUP | 2),
    ...
    MON4("hedrow", "drow", "drow",
        S_HUMAN, LVL(6, 12, 10, 60, -9), (G_GENO | G_SGROUP | 1),
      	A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),
      	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
      	SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), MR_SLEEP, MR_SLEEP,
      	M1_HUMANOID | M1_OMNIVORE,
      	M2_NOPOLY | M2_STRONG | M2_LORD | M2_COLLECT | M2_HOSTILE | M2_FLANK,
      	M3_INFRAVISION, MH_ELF, 11, CLR_BLACK),
    MON4("Elvenking", "Elvenqueen", "elven monarch",
    ...
    MON2("doppelganger", S_HUMAN, LVL(9, 12, 5, 20, 0), (G_GENO | 1),
    ...
    MON2("pack lord", S_HUMAN, LVL(12, 12, 10, 50, -7), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_WERE, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_POIS | M1_REGEN | M1_OMNIVORE,
        M2_NOPOLY | M2_HOSTILE | M2_COLLECT | M2_MAGIC,
        M3_INFRAVISIBLE, MH_HUMAN | MH_WERE, 15, CLR_ORANGE),
    MON2("shopkeeper", S_HUMAN, LVL(12, 18, 0, 50, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 4, 4), ATTK(AT_WEAP, AD_PHYS, 4, 4),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SELL, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_PEACEFUL
            | M2_STRONG | M2_COLLECT | M2_MAGIC,
        M3_INFRAVISIBLE, MH_HUMAN, 15, HI_DOMESTIC),
    MON2("Arms Dealer", S_HUMAN, LVL(25, 24, -8, 50, -2), (G_NOGEN | G_UNIQ),
    ...
    MON("extraplanar merchant", S_HUMAN, LVL(20, 18, 0, 50, 0), G_NOGEN,
        ...
        M2_NOPOLY | M2_PEACEFUL | M2_STRONG | M2_COLLECT | M2_MAGIC,
        M3_INFRAVISIBLE, 23, CLR_BLUE),
    MON2("guard", S_HUMAN, LVL(12, 12, 10, 40, 10), G_NOGEN,
    ...
    MON2("prisoner", S_HUMAN, LVL(12, 12, 10, 0, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON2("Oracle", S_HUMAN, LVL(12, 0, 0, 50, 0), (G_NOGEN | G_UNIQ),
    ...
    /* aligned priests always have the epri extension attached;
       ...
       or isminion set */
    MON4("priest", "priestess", "aligned cleric",
    ...
    MON4("high priest", "high priestess", "high cleric",
    ...
    MON2("soldier", S_HUMAN, LVL(6, 10, 10, 0, -2), (G_SGROUP | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON2("sergeant", S_HUMAN, LVL(8, 10, 10, 5, -3), (G_SGROUP | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SOLDIER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
    ...
    MON2("nurse", S_HUMAN, LVL(11, 6, 0, 0, 0), (G_GENO | 3),
    ...
    MON2("lieutenant", S_HUMAN, LVL(10, 10, 10, 15, -4), (G_GENO | 1),
    ...
    MON2("captain", S_HUMAN, LVL(12, 10, 10, 15, -5), (G_GENO | 1),
        ...
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
          | M2_HOSTILE | M2_STRONG | M2_COLLECT | M2_FLANK,
        M3_INFRAVISIBLE, MH_HUMAN, 14, CLR_BLUE),
    MON2("general", S_HUMAN, LVL(16, 10, 10, 15, -6), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 5, 4), ATTK(AT_WEAP, AD_PHYS, 5, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SOLDIER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_MERC | M2_STALK
          | M2_HOSTILE | M2_STRONG | M2_COLLECT | M2_FLANK,
        M3_INFRAVISIBLE, MH_HUMAN, 18, CLR_MAGENTA),
    MON2("watchman", S_HUMAN, LVL(6, 10, 10, 0, -2),
        ...
        M3_INFRAVISIBLE, MH_HUMAN, 8, CLR_GRAY),
    MON2("watch captain", S_HUMAN, LVL(10, 10, 10, 15, -4),
        (G_NOGEN | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 4), ATTK(AT_WEAP, AD_PHYS, 3, 4), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SOLDIER, MZ_HUMAN), 0, 0,
    ...
    MON2("Wizard of Yendor", S_HUMAN, LVL(30, 12, -8, 100, A_NONE),
        (G_NOGEN | G_UNIQ),
        ...
        M2_NOPOLY | M2_HOSTILE | M2_STRONG | M2_NASTY | M2_PRINCE | M2_MAGIC | M2_MALE,
        M3_COVETOUS | M3_WAITFORU | M3_INFRAVISIBLE, MH_HUMAN, 34, HI_LORD),
    MON2("Croesus", S_HUMAN, LVL(20, 15, 0, 40, 15), (G_UNIQ | G_NOGEN),
...
#ifdef CHARON
    MON2("Charon", S_HUMAN, LVL(76, 18, -5, 120, 0),
    ...
    MON2("shadow", S_GHOST,
        ...
        0, MH_UNDEAD, 9, CLR_BLACK),
    MON2("spectre", S_GHOST, LVL(10, 9, -8, 50, -5), (G_NOCORPSE | 1),
        ...
        CLR_BRIGHT_BLUE),
    MON2("ghost", S_GHOST, LVL(10, 3, -5, 50, -5), (G_NOCORPSE | G_NOGEN),
        ...
        12, CLR_GRAY),
    MON2("shade", S_GHOST, LVL(12, 10, 10, 0, 0), (G_NOCORPSE | G_NOGEN),
     ...
     * (major) demons
     */
    MON2("water demon", S_DEMON, LVL(8, 12, -4, 30, -7),
        (G_NOCORPSE | G_NOGEN),
    ...
    MON2("lava demon", S_DEMON, LVL(12, 12, -8, 40, -7),
     ...
     */
    MON2("infernal", S_DEMON, LVL(0, 12, 10, 0, 0), G_NOGEN, /* for corpses */
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), MR_FIRE, MR_FIRE,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_STRONG |
        M2_COLLECT, M3_INFRAVISIBLE | M3_INFRAVISION,
        MH_DEMON, 2, HI_DOMESTIC),
    MON2("gehennan maw", S_DEMON, LVL(2, 6, 8, 20, -7), (G_GENO | G_HELL | G_LGROUP | 5),
        A(ATTK(AT_BITE, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(20, 10, MS_GROWL, MZ_TINY), 0, 0, M1_REGEN | M1_MINDLESS,
        M2_WANDER | M2_HOSTILE | M2_STALK | M2_NEUTER,
        M3_INFRAVISIBLE, MH_DEMON, 8, CLR_GREEN),
    MON2("aspect of Zuggotomoy", S_DEMON, LVL(5, 12, -4, 30, -15),
        (G_NOCORPSE | G_NOGEN),
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON4("incubus", "succubus", "amorous demon",
    ...
    MON2("horned devil", S_DEMON, LVL(6, 9, -5, 50, 11),
        (G_HELL | G_NOCORPSE | 2),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DEMON, 9, CLR_BROWN),
    /* Used by AD&D for a type of demon, originally one of the Furies
       and spelled this way */
    MON2("erinys", S_DEMON, LVL(7, 12, 2, 30, 10),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DEMON, 10, CLR_RED),
    MON2("barbed devil", S_DEMON, LVL(8, 12, 0, 35, 8),
        (G_HELL | G_NOCORPSE | G_SGROUP | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4),
        ...
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_HUMAN), MR_FIRE | MR_POISON, 0,
        M1_POIS | M1_THICK_HIDE, M2_STALK | M2_HOSTILE | M2_NASTY | M2_FLANK,
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DEMON, 12, CLR_RED),
    MON2("marilith", S_DEMON, LVL(7, 12, -6, 80, -12),
        (G_HELL | G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DEMON, 11, CLR_RED),
    MON2("bar-lgura", S_DEMON,
    ...
    MON2("chasme", S_DEMON, 
        ...
        MR_FIRE | MR_POISON, 0, M1_POIS | M1_FLY,
        M2_STALK | M2_HOSTILE | M2_NASTY | M2_FLANK, 
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DEMON,13,  CLR_CYAN),
    MON2("vrock", S_DEMON, LVL(8, 12, 0, 50, -9),
        (G_HELL | G_NOCORPSE | G_SGROUP | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DEMON, 11, CLR_RED),
    MON2("hezrou", S_DEMON, LVL(9, 6, -2, 55, -10),
        (G_HELL | G_NOCORPSE | G_SGROUP | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 3), ATTK(AT_CLAW, AD_PHYS, 1, 3),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DEMON, 12, CLR_RED),
    MON2("bone devil", S_DEMON, LVL(9, 15, -1, 40, -9),
        (G_HELL | G_NOCORPSE | G_SGROUP | 2),
    ...
    MON2("armanite", S_DEMON, LVL(9, 20, 2, 10, -3),
        (G_GENO | G_LGROUP | G_HELL | 2),
    ...
    MON2("ice devil", S_DEMON, LVL(11, 6, -4, 55, -12),
        (G_HELL | G_NOCORPSE | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
        ...
        M2_STALK | M2_HOSTILE | M2_NASTY | M2_FLANK,
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DEMON, 14, CLR_WHITE),
    MON2("nalfeshnee", S_DEMON, LVL(11, 9, -1, 65, -11),
        (G_HELL | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
        ...
        M1_HUMANOID | M1_POIS, M2_STALK | M2_HOSTILE | M2_NASTY | M2_FLANK,
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DEMON, 15, CLR_RED),
    MON2("spibrawulf", S_DEMON, LVL(11, 18, 3, 35, -12),
        (G_HELL | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 3, 4), ATTK(AT_CLAW, AD_PHYS, 3, 4),
          ATTK(AT_BITE, AD_DRCO, 3, 4), ATTK(AT_STNG, AD_LARV, 1, 4),
          NO_ATTK, NO_ATTK),
        SIZ(1600, 400, MS_BARK, MZ_LARGE), MR_FIRE | MR_ELEC | MR_POISON, 0,
        M1_POIS, M2_STALK | M2_HOSTILE | M2_NASTY | M2_FLANK,
        M3_INFRAVISION, MH_DEMON, 15, CLR_GRAY),
    MON2("pit fiend", S_DEMON, LVL(13, 6, -3, 65, -13),
        (G_HELL | G_NOCORPSE | 2),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DEMON, 16, CLR_RED),
    ...
    MON2("headless rider", S_DEMON, LVL(14, 15, 10, 40, 0),
        (G_HELL | G_NOCORPSE | 1),
        ...
        M2_NASTY | M2_COLLECT | M2_HOSTILE,
        M3_INFRAVISIBLE | M3_INFRAVISION, MH_DEMON, 16, CLR_WHITE),
    MON2("balrog", S_DEMON, LVL(16, 5, -2, 75, -14), (G_HELL | G_NOCORPSE | 1),
    ...
    MON2("molydeus", S_DEMON, LVL(20, 12, -3, 40, -10), (G_HELL | G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 4), ATTK(AT_WEAP, AD_PHYS, 4, 4),
     ...
     */
    MON2("Juiblex", S_DEMON, LVL(50, 3, -7, 65, -15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        MH_DEMON, 26, CLR_BRIGHT_GREEN),
    MON2("Zuggotomoy", S_DEMON, LVL(51, 5, -4, 65, -15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
    ...
    MON2("Buer", S_DEMON, LVL(52, 20, -5, 70, -15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
    ...
    MON2("Pazuzu", S_DEMON, LVL(53, 18, -2, 65, 15),
    ...
    MON2("Kostchtchie", S_DEMON, LVL(54, 15, 3, 30, -15),
        (G_HELL | G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_CLOB, 5, 10), ATTK(AT_WEAP, AD_FUMB, 2, 8),
    ...
    MON2("Yeenoghu", S_DEMON, LVL(56, 18, -5, 80, -15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        MH_DEMON, 31, HI_LORD),
    MON2("Baphomet", S_DEMON, LVL(56, 15, -5, 70, -15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        M3_INFRAVISIBLE | M3_INFRAVISION | M3_WANTSAMUL,
        MH_DEMON, 32, HI_LORD),
    MON2("Orcus", S_DEMON, LVL(66, 9, -6, 85, -20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        36, HI_LORD),
    MON2("Geryon", S_DEMON, LVL(72, 3, -3, 75, 15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        A(ATTK(AT_CLAW, AD_PHYS, 3, 6), ATTK(AT_CLAW, AD_PHYS, 3, 6),
        ...
        M3_WANTSAMUL | M3_INFRAVISIBLE | M3_INFRAVISION,
        MH_DEMON, 36, HI_LORD),
    MON2("Dispater", S_DEMON, LVL(78, 15, -2, 80, 15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        M3_WANTSAMUL | M3_INFRAVISIBLE | M3_INFRAVISION,
        MH_DEMON, 40, HI_LORD),
    MON2("Malcanthet", S_DEMON, LVL(80, 15, -6, 80, 15),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        42, HI_LORD),
    MON2("Baalzebub", S_DEMON, LVL(89, 9, -5, 85, 20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        MH_DEMON, 45, HI_LORD),
    MON2("Mephistopholes", S_DEMON, LVL(105, 12, -17, 90, 20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        53, HI_LORD),
    MON2("Asmodeus", S_DEMON, LVL(105, 12, -7, 90, 20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        ...
        M3_WANTSAMUL | M3_WAITFORU | M3_INFRAVISIBLE | M3_INFRAVISION,
        MH_DEMON, 53, HI_LORD),
    MON2("Demogorgon", S_DEMON, LVL(106, 15, -8, 95, -20),
        (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
    ...
    MON("mail daemon", S_DEMON, LVL(56, 24, 10, 127, 0),
        ...
        26, CLR_BRIGHT_BLUE),
#endif
    MON("jann", S_DEMON, LVL(4, 12, 6, 10, 0), (G_GENO | G_NOCORPSE | 2),
    ...
    MON("efreet", S_DEMON, LVL(15, 15, 4, 42, 0), (G_NOGEN | G_NOCORPSE),
        ...
        M2_NOPOLY | M2_STALK | M2_COLLECT | M2_STRONG | M2_FLANK,
    ...
    MON2("merfolk", S_EEL, LVL(3, 12, 4, 10, 0), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE | M1_SWIM | M1_AMPHIBIOUS,
        M2_COLLECT | M2_HOSTILE, M3_INFRAVISIBLE,
        MH_MERFOLK, 5, CLR_GREEN),
    ...
    MON("sea horse", S_EEL, LVL(6, 20, 5, 0, 0), (G_GENO | 2),
        ...
        M1_SLITHY, M2_WANDER | M2_STRONG | M2_DOMESTIC, M3_INFRAVISIBLE,
        8, HI_DOMESTIC),
    ...
    MON("thing from below", S_EEL, LVL(30, 12, 6, 0, -3), (G_GENO | G_NOGEN),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_MAGC, AD_SPEL, 4, 4),
          ATTK(AT_HUGS, AD_WRAP, 2, 6), ATTK(AT_BITE, AD_PHYS, 5, 4), NO_ATTK,
          NO_ATTK),
        SIZ(1800, 1000, MS_SILENT, MZ_GIGANTIC), 0, 0,
        M1_SWIM | M1_AMPHIBIOUS | M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE,
        M2_NOPOLY | M2_HOSTILE | M2_STRONG, M3_INFRAVISIBLE, 34, HI_LORD),
    /*
     * lizards, &c
     */
    ...
    MON("velociraptor", S_LIZARD, LVL(7, 18, 5, 0, 0), (G_NOGEN | G_SGROUP | 6),
        ...
        M1_SWIM | M1_AMPHIBIOUS | M1_ANIMAL | M1_THICK_HIDE | M1_NOHANDS
            | M1_CARNIVORE,
        M2_STRONG | M2_HOSTILE | M2_FLANK, 0, 9, CLR_RED),
    ...
    MON("salamander", S_LIZARD, LVL(8, 12, -1, 0, -9), (G_HELL | 1),
        ...
        12, CLR_ORANGE),
    MON("T-Rex", S_LIZARD, LVL(15, 15, 5, 0, 0), (G_NOGEN | 4),
        ...
        M2_STRONG | M2_HOSTILE, M3_INFRAVISIBLE, 18, CLR_RED),
    /* Hydras used to use the symbol for dragons, but this led to them appearing
       far too often in the castle level. By changing them to the lizard class,
       we avoid that, and also make lizards a more viable geno target. */
    MON("hydra", S_LIZARD, LVL(13, 9, -2, 5, 7), (G_GENO | 1),
       	A(ATTK(AT_NONE, AD_HYDR, 0, 0), ATTK(AT_BITE, AD_PHYS, 3, 6),
            NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("long worm tail", S_WORM_TAIL, LVL(0, 0, 0, 0, 0),
        (G_NOGEN | G_NOCORPSE | G_UNIQ), NO_ATTKS,
        NO_SIZ, 0, 0, 0L, M2_NOPOLY, 0, 1, CLR_BROWN),
    /* Note:
     ...
     * character classes
     */
    MON2("archeologist", S_HUMAN, LVL(10, 12, 10, 1, 3), G_NOGEN,
    ...
    MON2("barbarian", S_HUMAN, LVL(10, 12, 10, 1, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_SAMU, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        ...
        M2_NOPOLY | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        MH_HUMAN, 12, HI_DOMESTIC),
    MON2("cartomancer", S_HUMAN, LVL(10, 12, 10, 3, 0), G_NOGEN,
    ...
    MON4("caveman", "cavewoman", "cave dweller",
        ...
        M2_NOPOLY | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, MH_HUMAN, 12, HI_DOMESTIC),
    MON2("convict", S_HUMAN,	LVL(10, 12, 10, 1, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_SAMU, 1, 6), ATTK(AT_WEAP, AD_SAMU, 1, 6),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        MH_HUMAN, 12, HI_DOMESTIC),
    MON2("dragon rider", S_HUMAN, LVL(10, 12, 10, 1, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_SAMU, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        MH_HUMAN, 13, HI_DOMESTIC),
    MON2("healer", S_HUMAN, LVL(10, 12, 10, 1, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_SAMU, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        MH_HUMAN, 12, HI_DOMESTIC),
    MON2("knight", S_HUMAN, LVL(10, 12, 10, 1, 3), G_NOGEN,
        ...
        M2_NOPOLY | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        MH_HUMAN, 12, HI_DOMESTIC),
    MON2("monk", S_HUMAN, LVL(10, 12, 10, 2, 0), G_NOGEN,
    ...
    MON4("priest", "priestess", "cleric",
        ...
        M2_NOPOLY | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, MH_HUMAN, 12, HI_DOMESTIC),
    MON2("pirate", S_HUMAN, LVL(10, 12, 10, 1, -3), G_NOGEN,
       	A(ATTK(AT_WEAP, AD_SAMU, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6),
       	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
       	SIZ(WT_HUMAN, 400, MS_PIRATE, MZ_HUMAN), 0, 0,
       	M1_HUMANOID | M1_OMNIVORE,
       	M2_NOPOLY | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
       	MH_HUMAN, 12, HI_DOMESTIC),
    MON2("ranger", S_HUMAN, LVL(10, 12, 10, 2, -3), G_NOGEN,
        ...
        M2_NOPOLY | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        MH_HUMAN, 12, HI_DOMESTIC),
    MON2("rogue", S_HUMAN, LVL(10, 12, 10, 1, -3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_SAMU, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_COLLECT,
        M3_INFRAVISIBLE, MH_HUMAN, 12, HI_DOMESTIC),
    MON2("samurai", S_HUMAN, LVL(10, 12, 10, 1, 3), G_NOGEN,
        ...
        M2_NOPOLY | M2_STRONG | M2_COLLECT, M3_INFRAVISIBLE,
        MH_HUMAN, 12, HI_DOMESTIC),
    MON2("tourist", S_HUMAN, LVL(10, 12, 10, 1, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_SAMU, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON2("valkyrie", S_HUMAN, LVL(10, 12, 10, 1, 1), G_NOGEN,
        ...
        M3_INFRAVISIBLE, MH_HUMAN, 12, HI_DOMESTIC),
    MON2("wizard", S_HUMAN, LVL(10, 12, 10, 3, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_SAMU, 1, 6), ATTK(AT_MAGC, AD_SPEL, 0, 0), 
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_STRONG | M2_COLLECT | M2_MAGIC,
     ...
     * quest leaders
     */
    MON2("Lord Carnarvon", S_HUMAN, LVL(20, 15, 0, 90, 20), (G_NOGEN | G_UNIQ),
    ...
    MON2("Pelias", S_HUMAN, LVL(20, 15, 0, 90, 0), (G_NOGEN | G_UNIQ),
        ...
        M2_NOPOLY | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, MH_HUMAN, 22, HI_LORD),
    MON2("Shaman Karnov", S_HUMAN, LVL(20, 15, 0, 90, 20), (G_NOGEN | G_UNIQ),
        ...
        M2_NOPOLY | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, MH_HUMAN, 22, HI_LORD),
    MON4("King of Games", "Queen of Games", "King of Games",
        S_HUMAN, LVL(20, 12, 0, 60, 0),
        (G_NOGEN | G_UNIQ),
    ...
    MON2("Hippocrates", S_HUMAN, LVL(20, 15, 0, 90, 0), (G_NOGEN | G_UNIQ),
        ...
        M2_NOPOLY | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, MH_HUMAN, 22, HI_LORD),
    MON4("King Arthur", "Queen Arthur", "Arthur",
    ...
    MON2("Grand Master", S_HUMAN, LVL(25, 15, 0, 90, 0), (G_NOGEN | G_UNIQ),
    ...
    MON2("Arch Priest", S_HUMAN, LVL(25, 15, 7, 90, 0), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10), ATTK(AT_KICK, AD_PHYS, 2, 8),
          ATTK(AT_MAGC, AD_CLRC, 2, 8), ATTK(AT_MAGC, AD_CLRC, 2, 8), NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_LEADER, MZ_HUMAN),
    ...
    MON2("Mayor Cummerbund", S_HUMAN, LVL(20, 12, 0, 70, 0), (G_NOGEN | G_UNIQ),
        ...
        | M2_MALE | M2_PNAME | M2_GREEDY | M2_JEWELS,
      	M3_CLOSE | M3_INFRAVISIBLE, MH_HUMAN, 23, HI_LORD),
    MON2("Orion", S_HUMAN, LVL(20, 15, 0, 90, 0), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10), ATTK(AT_MAGC, AD_SPEL, 4, 8),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
     ...
     */
    MON2("Master of Thieves", S_HUMAN, LVL(20, 15, 0, 90, -20),
        (G_NOGEN | G_UNIQ),
        ...
        M3_CLOSE | M3_INFRAVISIBLE, MH_HUMAN, 24, HI_LORD),
    MON2("Lord Sato", S_HUMAN, LVL(20, 15, 0, 90, 20), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10), ATTK(AT_WEAP, AD_PHYS, 4, 10), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_LEADER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE
            | M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, MH_HUMAN, 23, HI_LORD),
    MON2("Twoflower", S_HUMAN, LVL(20, 15, 10, 90, 0), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10), NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_LEADER, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    /* for a valkyrie hero, Norn's alignment will be changed to match hero's
       starting alignment */
    MON2("Norn", S_HUMAN, LVL(20, 15, 0, 90, 0), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10), ATTK(AT_WEAP, AD_PHYS, 4, 10), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        ...
        M2_NOPOLY | M2_PEACEFUL | M2_STRONG | M2_FEMALE
            | M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, MH_HUMAN, 23, HI_LORD),
    MON2("Neferet the Green", S_HUMAN, LVL(20, 15, 0, 90, 0),
        (G_NOGEN | G_UNIQ),
     ...
     * quest nemeses
     */
    MON2("Minion of Huhetotl", S_DEMON, LVL(16, 12, -2, 75, -14),
        ...
        MH_DEMON, 23, CLR_RED),
    MON2("Thoth Amon", S_HUMAN, LVL(16, 12, 0, 10, -14),
    ...
    MON("Warden Arianna", S_HUMAN, LVL(20, 12, 0, 40, -14),
        ...
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISIBLE, 25, HI_LORD),
    MON2("Cyclops", S_GIANT, LVL(18, 12, 0, 0, -15), (G_NOGEN | G_UNIQ),
    ...
    MON2("Slipscale the Betrayer", S_HUMAN, LVL(15, 12, 0, 40, -13),
        (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), ATTK(AT_WEAP, AD_PHYS, 2, 6),
          ATTK(AT_CLAW, AD_SAMU, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("Voanairruth", S_DRAGON, LVL(15, 9, -1, 20, -5),
        ...
        M2_MAGIC | M2_NOPOLY, 0, 21, CLR_WHITE),
    MON2("Master Kaen", S_HUMAN, LVL(25, 12, -10, 10, -20), (G_NOGEN | G_UNIQ),
        ...
        M3_WANTSARTI | M3_WAITFORU | M3_INFRAVISIBLE,
        MH_HUMAN, 31, HI_LORD),
    MON2("Blackbeard's Ghost", S_GHOST, LVL(15, 12, -5, 50, -30),
        (G_NOCORPSE | G_NOGEN | G_UNIQ),
    ...
    MON2("Nalzok", S_DEMON, LVL(16, 12, -2, 85, -127),
        (G_NOGEN | G_UNIQ | G_NOCORPSE),
        A(ATTK(AT_WEAP, AD_PHYS, 8, 4), ATTK(AT_WEAP, AD_PHYS, 4, 6),
          ATTK(AT_MAGC, AD_SPEL, 0, 0), ATTK(AT_CLAW, AD_SAMU, 2, 6), NO_ATTK,
          NO_ATTK),
    ...
    MON2("Master Assassin", S_HUMAN, LVL(15, 12, 0, 30, 18),
        (G_NOGEN | G_UNIQ),
     ...
     * of his time.
     */
    MON2("Ashikaga Takauji", S_HUMAN, LVL(15, 12, 0, 40, -13),
        (G_NOGEN | G_UNIQ | G_NOCORPSE),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6), ATTK(AT_WEAP, AD_PHYS, 2, 6),
          ATTK(AT_CLAW, AD_SAMU, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_NEMESIS, MZ_HUMAN), MR_STONE, 0,
     ...
     */
    MON2("Lord Surtur", S_GIANT, LVL(15, 12, 2, 50, 12), (G_NOGEN | G_UNIQ),
     ...
     * quest "guardians"
     */
    MON2("student", S_HUMAN, LVL(5, 12, 10, 10, 3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON4("chieftain", "chieftaness", "chieftain",
        S_HUMAN, LVL(5, 12, 10, 10, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        ...
        M2_NOPOLY | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, MH_HUMAN, 7, HI_DOMESTIC),
    MON2("neanderthal", S_HUMAN, LVL(5, 12, 10, 10, 1), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("inmate", S_HUMAN, LVL(12, 12, 10, 0, 0), G_NOGEN,
        ...
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE | M3_CLOSE, 14, CLR_BLACK),
    MON("bugbear caretaker", S_HUMANOID, LVL(5, 9, 5, 10, 3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON2("attendant", S_HUMAN, LVL(5, 12, 10, 10, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), MR_POISON, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, MH_HUMAN, 7, HI_DOMESTIC),
    MON2("page", S_HUMAN, LVL(5, 12, 10, 10, 3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, MH_HUMAN, 7, HI_DOMESTIC),
    MON2("abbot", S_HUMAN, LVL(5, 12, 10, 20, 0), G_NOGEN,
    ...
    MON2("acolyte", S_HUMAN, LVL(5, 12, 10, 20, 0), G_NOGEN,
        ...
        M2_NOPOLY | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, MH_HUMAN, 8, HI_DOMESTIC),
    MON4("pirate brother", "pirate sister", "pirate crewmate",
        S_HUMAN, LVL(5, 12, 10, 10, -3), G_NOGEN,
       	A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6),
       	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
       	SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
       	M1_HUMANOID | M1_OMNIVORE,
       	...
       	M3_INFRAVISIBLE, MH_HUMAN, 7, HI_DOMESTIC),
    MON4("hunter", "huntress", "hunter", S_HUMAN, LVL(5, 12, 10, 10, -7), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_SEE_INVIS | M1_OMNIVORE,
    ...
    MON2("thug", S_HUMAN, LVL(5, 12, 10, 10, -3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
        ...
        M3_INFRAVISIBLE, MH_HUMAN, 7, HI_DOMESTIC),
    MON2("ninja", S_HUMAN, LVL(5, 12, 10, 10, 3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_HUMANOID, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_HOSTILE | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, MH_HUMAN, 7, HI_DOMESTIC),
    MON2("roshi", S_HUMAN, LVL(5, 12, 10, 10, 3), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, MH_HUMAN, 7, HI_DOMESTIC),
    MON2("guide", S_HUMAN, LVL(5, 12, 10, 20, 0), G_NOGEN,
    ...
    MON2("warrior", S_HUMAN, LVL(5, 12, 10, 10, -1), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_PEACEFUL
        ...
        M3_INFRAVISIBLE, MH_HUMAN, 7, HI_DOMESTIC),
    MON2("apprentice", S_HUMAN, LVL(5, 12, 10, 30, 0), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_MAGC, AD_SPEL, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
        M1_HUMANOID | M1_OMNIVORE, M2_NOPOLY | M2_PEACEFUL
    ...
    MON("", 0, LVL(0, 0, 0, 0, 0), (0),
        NO_ATTKS, NO_SIZ, 0, 0, 0L, 0L, 0, 0, 0)
};
...
NEARDATA struct permonst montemplates[] = {
    MON2("elven", S_HUMAN, LVL(0, 0, 0, 0, -3), (0),
        NO_ATTKS, NO_SIZ, MR_SLEEP, MR_SLEEP, M1_SEE_INVIS, 0,
        M3_INFRAVISION | M3_INFRAVISIBLE, MH_ELF, 0, 0),
    MON2("half-elf", S_HUMAN, LVL(0, 0, 0, 0, -1), (0),
        NO_ATTKS, NO_SIZ, MR_SLEEP, MR_SLEEP, 0, 0,
        M3_INFRAVISION | M3_INFRAVISIBLE, MH_HUMAN | MH_ELF, 0, 0),
    MON2("gnomish", S_GNOME, LVL(0, 0, -1, 0, 0), (0),
        NO_ATTKS, NO_SIZ, 0, 0, 0, 0,
        M3_INFRAVISION | M3_INFRAVISIBLE, MH_GNOME, 0, 0),
    MON2("dwarvish", S_HUMANOID, LVL(0, 0, 0, 10, 4), (0),
        NO_ATTKS, NO_SIZ, 0, 0,
        M1_TUNNEL | M1_NEEDPICK,
        M2_STRONG | M2_JEWELS | M2_COLLECT,
        M3_INFRAVISION | M3_INFRAVISIBLE, MH_DWARF, 0, 0),
    MON2("orcish", S_ORC, LVL(0, 0, 0, 0, 0), (0),
        NO_ATTKS, NO_SIZ, 0, 0, 0L,
        M2_STRONG | M2_GREEDY | M2_JEWELS,
        M3_INFRAVISION | M3_INFRAVISIBLE, MH_ORC, 0, 0),
    MON2("half orc", S_ORC, LVL(0, 1, 0, 0, 0), (0),
        NO_ATTKS, NO_SIZ, 0, 0, 0L,
        M2_STRONG | M2_GREEDY | M2_JEWELS,
        M3_INFRAVISION | M3_INFRAVISIBLE, MH_ORC | MH_HUMAN, 0, 0),
    MON2("fiendish", S_DEMON, LVL(0, 0, 0, 15, -4), (0),
        NO_ATTKS, NO_SIZ, MR_FIRE, MR_FIRE,
        M1_POIS, 0, 0, MH_DEMON, 2, 0),
    MON("half-illithid", S_HUMANOID, LVL(0, 0, -3, 40, -3), (0),
        A(ATTK(AT_TENT, AD_DRIN, 2, 1), ATTK(AT_TENT, AD_DRIN, 2, 1),
          ATTK(AT_TENT, AD_DRIN, 2, 1), NO_ATTK, NO_ATTK, NO_ATTK),
        NO_SIZ, MR_PSYCHIC, 0, 0L, 0L, 0, 7, 0),
    MON2("shadowy", S_GHOST, LVL(2, 2, -3, 0, 3), (0),
        NO_ATTKS, NO_SIZ, MR_COLD | MR_STONE, MR_COLD | MR_STONE,
        M1_WALLWALK | M1_UNSOLID | M1_BREATHLESS | M1_FLY,
        M2_STALK, 0, MH_UNDEAD, 2, 0),
    MON2("vampiric", S_VAMPIRE, LVL(0, 2, -3, 0, -3), (0),
        A(ATTK(AT_BITE, AD_DRLI, 1, 6), NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK), NO_SIZ, 0, 0,
        M1_FLY | M1_POIS | M1_REGEN | M1_BREATHLESS,
        M2_STALK | M2_STRONG, 0, MH_UNDEAD, 4, 0),
    MON("armored", S_ANT, LVL(0, -2, -6, 0, 0), (0),
        NO_ATTKS, NO_SIZ, 0, 0, 0L, M2_STRONG, 0, 2, 0),
    MON("elite", S_HUMAN, LVL(3, 2, -3, 10, 0), (0),
        NO_ATTKS, NO_SIZ, 0, 0, 0L,
        M2_PRINCE | M2_FLANK, 0, 3, 0),
    MON("oozing", S_PUDDING, LVL(0, 0, 0, 0, 0), (0),
        A(ATTK(AT_TUCH, AD_SLIM, 1, 2), NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK), NO_SIZ,
        MR_COLD | MR_ELEC | MR_POISON | MR_ACID | MR_STONE,
        MR_COLD | MR_ELEC | MR_POISON,
    ...
    MON("overclocked", S_HUMANOID, LVL(0, 7, 0, 0, 0), (0),
        NO_ATTKS, NO_SIZ, 0, 0, 0, M2_WANDER, 0, 4, 0),
    /* sticky, spicy "demilichen". this mucilage is tangy! */
    MON("corrosive", S_FUNGUS, LVL(0, 0, 2, 0, 0), (0),
        A(ATTK(AT_NONE, AD_ACID, 2, 6), ATTK(AT_TUCH, AD_STCK, 0, 0),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(50, 100, 0, 0),
        MR_ACID | MR_POISON | MR_STONE, MR_ACID,
        M1_NOEYES | M1_MINDLESS, M2_HOSTILE,
        0, 1, CLR_ORANGE),
    MON("draconic", S_DRAGON, LVL(2, -2, 2, 10, 0), (0),
        A(ATTK(AT_BREA, AD_FIRE, 6, 6), NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        ...
        0, 4, CLR_RED),
    MON("icy draconic", S_DRAGON, LVL(2, -2, 2, 10, 0), (0),
        A(ATTK(AT_BREA, AD_COLD, 6, 6), NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("explosive", S_EYE, LVL(1, 0, 0, 0, 0), (G_NOCORPSE),
        A(ATTK(AT_BOOM, AD_PHYS, 4, 10), NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        NO_SIZ, 0, 0, 0L, 0L, 0, 1, 0),
    MON("spiny", S_DEMON, LVL(0, 0, 5, 0, 0), (0),
        A(ATTK(AT_NONE, AD_QUIL, 3, 5), ATTK(AT_VOLY, AD_QUIL, 8, 2),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        NO_SIZ, MR_SLEEP | MR_POISON, MR_POISON,
