...
NEARDATA struct permonst mons[] = {
    ...
    MON("barghest", S_DOG, LVL(7, 12, 4, 20, -7), (G_GENO | 1),
        ...
        9, CLR_BLACK),
    MON("guard dog", S_DOG, LVL(9, 14, 4, 0, 0), (G_GENO | G_NOGEN),
    ...
    MON("fat cat", S_FELINE, LVL(9, 14, 3, 0, 0), (G_GENO | G_NOGEN),
        A(ATTK(AT_BITE, AD_PHYS, 3, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
    ...
    MON("emperor penguin", S_BAT, LVL(6, 15, 4, 0, 0), (G_GENO | G_NOGEN),
        ...
        M3_INFRAVISIBLE, 0, 7, HI_DOMESTIC),
    MON("tuxedo penguin", S_BAT, LVL(9, 14, 4, 0, 0), (G_GENO | G_NOGEN),
        A(ATTK(AT_BITE, AD_PHYS, 3, 4), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
