...
WEAPON("spear", None,
       1, 1, 0, 52,  30,   3,  6,  8, 0, P,   P_SPEAR, IRON, HI_METAL),
WEAPON("elven spear", "runed spear",
       0, 1, 0, 10,  30,   3,  7,  8, 0, P,   P_SPEAR, COPPER, HI_COPPER),
...
WEAPON("elven dagger", "runed dagger",
       0, 1, 0, 10,  10,   4,  5,  3, 2, P,   P_DAGGER, COPPER, HI_COPPER),
...
WEAPON("elven broadsword", "runed broadsword",
       0, 0, 0,  4,  70,  10,  6,  6, 0, S,   P_BROAD_SWORD, COPPER, HI_COPPER),
        /* +d4 small, +1 large */
...
WEAPON("war hammer", None,
       1, 0, 0, 15,  50,   5,  12,  12, 0, B,   P_HAMMER, IRON, HI_METAL),
        /* +1 small */
WEAPON("club", None,
       1, 0, 0, 12,  30,   3,  6,  3, 0, B,   P_CLUB, WOOD, HI_WOOD),
WEAPON("baseball bat", None,
       1, 0, 0, 0,  50,   3,  6,  3, 2, B,   P_CLUB, WOOD, HI_WOOD),
...
BOW("elven bow", "runed bow",  0, 11, 30, 60, 0, WOOD, P_BOW, HI_WOOD),
...
HELM("helm of opposite alignment", "crested helmet",
     0, 1,           0,  4, 1, 50, 50,  9, 0, IRON, HI_METAL),
...
ARMOR("crystal plate mail", None,
      1, 0, 1,  0, 35, 5, 450, 820,  3, 2,  ARM_SUIT, GLASS, CLR_WHITE),
...
ARMOR("dark elven ring mail", None,
	    1, 0, 0, 0,  0,  1, 150, 240,  4, 3,  ARM_SUIT, SILVER, CLR_BLACK),
ARMOR("orcish ring mail", "crude ring mail",
      0, 0, 0,  0, 40, 5, 250,  60,  8, 1,  ARM_SUIT, IRON, CLR_BLACK),
...
CLOAK("elven cloak", "faded pall",
      0, 1,    STEALTH,  4, 0, 10, 60,  9, 1,  CLOTH, CLR_BLACK),
CLOAK("second skin", "fleshy wrap",
      0, 1,    REGENERATION,  4, 0, 10, 60,  10, 1, FLESH, CLR_RED),
...
CLOAK("mantle", "armored cloak",
      0, 0,          0,  4, 0, 30, 70, 7, 1,  IRON, CLR_GRAY),
CLOAK("oilskin cloak", "slippery cloak",
      0, 0,          0,  4, 0, 10, 50,  9, 2,  CLOTH, HI_CLOTH),
CLOAK("mystic robe", "fine robe",
      0, 1,          0,  3, 0, 15, 50,  8, 2,  CLOTH, CLR_RED),
CLOAK("robe of the blood magus", "starry robe",
      0, 1,    BLOODMAGIC,  3, 0, 15, 50,  8, 2,  CLOTH, CLR_BLUE),
CLOAK("robe of stasis", "bleached robe",
      0, 1,    UNCHANGING,  3, 0, 15, 50,  8, 2,  CLOTH, CLR_WHITE),
...
SHIELD("small shield", None,
       1, 0, 0,          0, 3, 0,  30,  3, 9, 0,  WOOD, HI_WOOD),
...
SHIELD("shield of resonance", "vibrating shield",
...
RING("sickness resistance", "moolooite",
      SICK_RES,                200, 1, 0,  3, MINERAL, CLR_GREEN),
...
CONTAINER("bag of tricks",  "bag", 0, 1, 1, 15,  15, 100, CLOTH, HI_CLOTH),
...
TOOL("spirit candle",    "green candle", 0, 0, 1, 0, 5,  2, 20, WAX, CLR_GREEN),
TOOL("automaton candle", "blue candle", 0, 0, 1, 0, 5,  2, 20, WAX, CLR_BLUE),
TOOL("calling candle",   "red candle", 0, 0, 1, 0, 2,  2, 20, WAX, CLR_RED),
...
POTION("extra healing",          "puce",  1, 0, 27, 100, CLR_RED),
POTION("gain level",            "milky",  1, 0, 20, 300, CLR_WHITE),
POTION("enlightenment",        "swirly",  1, 0, 20, 200, CLR_BROWN),
POTION("orcish war juice",    "noxious",  1, 0, 20, 200, CLR_GREEN),
...
SPELL("fireball",        "ragged",
      P_ATTACK_SPELL,       5,  4, 4, 1, RAY, HI_PAPER),
...
SPELL("web",             "moldy",
      P_MATTER_SPELL,      10,  1, 1, 1, IMMEDIATE, HI_CLOTH),
...
ROCK("moonstone", "gray",  0,   0,  10, 85, 3, 3, 1, 10, 7, MINERAL, CLR_GRAY),
