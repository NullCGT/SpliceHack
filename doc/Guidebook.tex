...
dwarvish ring mail  & 4 &                   & elven ring mail    & 5\\
chain mail             & 5 &                   & orcish chain mail     & 6\\
scale mail             & 6 &                   & dragon scales         & 7\\
studded armor  & 7 &                   & ring mail             & 7\\
orcish ring mail       & 8 &                   & light armor         & 8\\
jacket         & 9 &                   & no armor              & 10\\
\end{tabular}
\end{center}
...
%.lp ""
On UNIX, Linux and Mac OS X it is \mbox{``.splicehackrc''} in the user's home
directory. The file may not exist, but it is a normal ASCII text file and
can be created with any text editor.\\

%.lp ""
On Windows, it is \mbox{``.splicehackrc''} in the folder
...
template for ths configuration file named \mbox{``.splicehackrc.template''} in
...
defaults to the location of the {\it SpliceHack.exe\/} or {\it NetHackw.exe\/} file
...
%.lp
\item[\ib{invweight}]
Augment object descriptions with their objects' weight (default on).
%.lp
\item[\ib{zerocomp}]
