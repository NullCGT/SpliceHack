...
NHSUBDIR="nh370.33-hdf"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/nh370.33-hdf/var/"
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-nh370.33-hdf"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-nh370.33-hdf"
