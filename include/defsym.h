...
#define MONSYM(idx, ch, basename, sym, desc) \
    ...
    MONSYM(26, 'z', ZRUTY, S_ZOUTHERN, "zouthern animal")
    ...
    MONSYM(34, '9', GNOLL, S_GNOLL, "gnoll")
    /* large humanoid: giant, ettin, minotaur */
    MONSYM(35, 'H', GIANT, S_GIANT, "giant humanoid")
    MONSYM(36, 'I', INVISIBLE, S_invisible, "invisible monster")
    MONSYM(37, 'J', JABBERWOCK, S_JABBERWOCK, "jabberwock")
    MONSYM(38, 'K', KOP, S_KOP, "Keystone Kop")
    MONSYM(39, 'L', LICH, S_LICH, "lich")
    MONSYM(40, 'M', MUMMY, S_MUMMY, "mummy")
    MONSYM(41, 'N', NAGA, S_NAGA, "naga")
    MONSYM(42, 'O', OGRE, S_OGRE, "ogre")
    MONSYM(43, 'P', PUDDING, S_PUDDING, "pudding or ooze")
    MONSYM(44, 'Q', QUANTMECH, S_QUANTMECH, "quantum mechanic")
    MONSYM(45, 'R', RUSTMONST, S_RUSTMONST, "rust monster or disenchanter")
    MONSYM(46, 'S', SNAKE, S_SNAKE, "snake")
    MONSYM(47, 'T', TROLL, S_TROLL, "troll")
    /* umber hulk */
    MONSYM(48, 'U', UMBER, S_UMBER, "umber hulk")
    MONSYM(49, 'V', VAMPIRE, S_VAMPIRE, "vampire")
    MONSYM(50, 'W', WRAITH, S_WRAITH, "wraith")
    MONSYM(51, 'X', XORN, S_XORN, "xorn")
    /* apelike creature includes owlbear, monkey */
    MONSYM(52, 'Y', YETI, S_YETI, "apelike creature")
    MONSYM(53, 'Z', ZOMBIE, S_ZOMBIE, "zombie")
    MONSYM(54, '@', HUMAN, S_HUMAN, "human or elf")
    /* space symbol*/
    MONSYM(55, ' ', GHOST, S_GHOST, "ghost")
    MONSYM(56, '\'', GOLEM, S_GOLEM, "golem")
    MONSYM(57, '&', DEMON, S_DEMON, "major demon")
    /* fish */
    MONSYM(58, ';',  EEL, S_EEL, "sea monster")
    /* reptiles */
...
#define OBJCLASS7(idx, ch, basename, sname, sym, name, explain) \
    ...
    OBJCLASS(14,  '`', ROCK, S_rock, "large stones", "boulder or statue or sconce")
