...
enum roomtype_types {
    ...
    DEN        =  6, /* contains wild animals */
    MORGUE     =  7, /* contains corpses, undead and graves */
    BARRACKS   =  8, /* contains soldiers and their gear */
    ZOO        =  9, /* floor covered with treasure and monsters */
    DELPHI     = 10, /* contains Oracle and peripherals */
    TEMPLE     = 11, /* contains a shrine (altar attended by priest[ess]) */
    LEPREHALL  = 12, /* leprechaun hall (Tom Proudfoot) */
    COCKNEST   = 13, /* cockatrice nest (Tom Proudfoot) */
    ARMORY     = 14, /* armory (L's dilapidated armory patch) */
    ANTHOLE    = 15, /* ants (Tom Proudfoot) */
    LEMUREPIT  = 16,  /* contains lemures and horned devils */
    BLACKFOYER = 17, /* black market foyer */
    ARTROOM    = 18, /* interesting walls */
    ...
    MASKSHOP   = 30,
    JUNKSHOP   = 31,
    FODDERSHOP = 32, /* health food store */
    CANDLESHOP = 33,
    BLACKSHOP  = 34
};
