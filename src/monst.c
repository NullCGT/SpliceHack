...
NEARDATA struct permonst mons_init[] = {
    ...
    MON("white horse", S_UNICORN, LVL(18, 24, 0, 70, 0), (G_NOGEN | G_NOCORPSE),
        ...
        SIZ(1800, 350, MS_NEIGH, MZ_LARGE), MR_COLD | MR_POISON, 0,
        M1_ANIMAL | M1_NOHANDS | M1_HERBIVORE | M1_FLY,
        M2_NOPOLY | M2_NASTY | M2_UNDEAD | M2_HOSTILE | M2_STRONG,
...
struct permonst _mons2[] = {
    ...
    MON3("stone giant", "stone giantess", "stone giant", 
    ...
    MON3("hill giant", "hill giantess", "hill giant", 
    ...
    MON3("fire giant", "fire giantess", "fire giant", 
    ...
    MON3("frost giant", "frost giantess", "frost giant", 
    ...
    MON3("storm giant", "storm giantess", "storm giant",
    ...
    MON("eye of fear and flame", S_LICH, LVL(16, 9, -4, 70, -13),
        (G_GENO | G_NOCORPSE | 1),
        ...
        MR_COLD, M1_BREATHLESS | M1_HUMANOID | M1_POIS | M1_REGEN,
        M2_UNDEAD | M2_HOSTILE | M2_MAGIC, M3_INFRAVISION, 18, CLR_ORANGE),
    ...
    MON3("giant mummy", "giantess mummy", "giant mummy", 
    ...
    MON("skeletal pirate", S_ZOMBIE, LVL(5, 8, 4, 0, 0),
        ...
        M2_WANDER | M2_HOSTILE | M2_UNDEAD | M2_STRONG | M2_COLLECT | M2_NASTY,
      	M3_INFRAVISION, 7, CLR_WHITE),
    MON3("giant zombie", "giantess zombie", "giant zombie", 
    ...
    MON("zombie dragon", S_ZOMBIE, LVL(14, 8, -1, 20, -4), (G_GENO | 1),
        ...
        M1_MINDLESS,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_MAGIC | M2_UNDEAD,
    ...
    MON("lava demon", S_DEMON, LVL(12, 12, -8, 40, -7), 
        ...
        M1_HUMANOID | M1_POIS,
        M2_NOPOLY | M2_STALK | M2_DEMON | M2_HOSTILE | M2_NASTY | M2_COLLECT,
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("bar-lgura", S_DEMON, 
        ...
        M2_STALK | M2_HOSTILE | M2_NASTY | M2_DEMON,
        M3_INFRAVISIBLE | M3_INFRAVISION, 10, CLR_ORANGE),
    ...
    MON("armanite", S_CENTAUR, LVL(9, 20, 2, 10, -3), 
        ...
        M1_HUMANOID | M1_OMNIVORE,
        M2_STRONG | M2_GREEDY | M2_COLLECT | M2_DEMON | M2_HOSTILE,
        M3_INFRAVISIBLE, 16, CLR_RED),
    MON("damned pirate", S_DEMON,
   	    ...
   	    MR_FIRE| MR_SLEEP | MR_POISON | MR_STONE, 0,
   	    M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID,
   	    M2_WANDER | M2_HOSTILE | M2_STRONG | M2_DEMON | M2_COLLECT | M2_NASTY,
    ...
    MON("headless rider", S_DEMON, LVL(14, 15, 10, 40, 0),
        (G_HELL | G_NOCORPSE | 1),
        ...
        M2_NASTY | M2_COLLECT | M2_HOSTILE | M2_DEMON,
        M3_INFRAVISIBLE | M3_INFRAVISION, 16, CLR_WHITE),
    ...
    MON("molydeus", S_DEMON, LVL(20, 12, -3, 40, -10), (G_HELL | G_NOCORPSE | 1),
        ...
        M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY | M2_COLLECT | M2_DEMON,
        M3_INFRAVISIBLE | M3_INFRAVISION, 25, CLR_MAGENTA),
    ...
    MON("convict", S_HUMAN,	LVL(10, 12, 10, 1, 0), G_NOGEN,
        ...
        12, HI_DOMESTIC),
    MON("dragon rider", S_HUMAN, LVL(10, 12, 10, 1, 0), G_NOGEN,
    ...
    MON("pirate", S_HUMAN, LVL(10, 12, 10, 1, -3), G_NOGEN,
       	...
       	M1_HUMANOID | M1_OMNIVORE,
       	M2_NOPOLY | M2_STRONG | M2_COLLECT | M2_HUMAN, M3_INFRAVISIBLE,
       	12, HI_DOMESTIC),
    ...
    MON("Robert the Lifer", S_HUMAN,
        ...
        M2_NOPOLY | M2_PNAME | M2_PEACEFUL | M2_STRONG | M2_MALE | 
          M2_COLLECT | M2_MAGIC,
        M3_CLOSE | M3_INFRAVISIBLE, 23, HI_DOMESTIC),
    ...
    MON("Mayor Cummerbund", S_HUMAN, LVL(20, 12, 0, 70, 0), (G_NOGEN | G_UNIQ),
      	...
      	M1_HUMANOID | M1_SEE_INVIS | M1_OMNIVORE,
      	M2_NOPOLY | M2_PEACEFUL | M2_STRONG | M2_COLLECT | M2_MAGIC
        | M2_MALE | M2_PNAME | M2_GREEDY | M2_JEWELS | M2_HUMAN,
      	M3_CLOSE | M3_INFRAVISIBLE, 23, HI_LORD),
    ...
    MON("Slipscale the Betrayer", S_HUMAN, LVL(15, 12, 0, 40, -13),
        ...
        M1_HUMANOID | M1_OMNIVORE,
        M2_NOPOLY | M2_PNAME | M2_HOSTILE | M2_STRONG | M2_STALK
            | M2_NASTY | M2_MALE | M2_COLLECT | M2_MAGIC | M2_HUMAN,
    ...
    MON("Blackbeard's Ghost", S_GHOST, LVL(15, 12, -5, 50, -30),
        (G_NOCORPSE | G_NOGEN | G_UNIQ),
      	...
      	M1_FLY | M1_BREATHLESS | M1_WALLWALK | M1_HUMANOID | M1_UNSOLID |
        M1_HUMANOID | M1_OMNIVORE,
      	M2_NOPOLY | M2_STALK | M2_HOSTILE | M2_STRONG | M2_HUMAN |
        M2_NASTY | M2_PNAME | M2_COLLECT | M2_MAGIC | M2_MALE | M2_UNDEAD,
    ...
    MON("student", S_HUMAN, LVL(5, 12, 10, 10, 3), G_NOGEN,
        ...
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, 7, HI_DOMESTIC),
    MON3("chieftain", "chieftaness", "chieftain",
    ...
    MON("acolyte", S_HUMAN, LVL(5, 12, 10, 20, 0), G_NOGEN,
        ...
        M2_NOPOLY | M2_HUMAN | M2_PEACEFUL | M2_STRONG | M2_COLLECT,
        M3_INFRAVISIBLE, 8, HI_DOMESTIC),
    MON3("pirate brother", "pirate sister", "pirate crewmate",
        S_HUMAN, LVL(5, 12, 10, 10, -3), G_NOGEN,
       	A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6),
       	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
       	SIZ(WT_HUMAN, 400, MS_GUARDIAN, MZ_HUMAN), 0, 0,
       	M1_HUMANOID | M1_OMNIVORE,
       	M2_NOPOLY | M2_PEACEFUL | M2_HUMAN | M2_STRONG | M2_GREEDY | M2_COLLECT,
       	M3_INFRAVISIBLE, 7, HI_DOMESTIC),
...
NEARDATA struct permonst montemplates[] = {
    ...
    MON("dwarvish", S_HUMANOID, LVL(0, 0, 0, 10, 4), (0),
        ...
        M3_INFRAVISION | M3_INFRAVISIBLE, 0, 0),
    MON("orcish", S_ORC, LVL(0, 0, 0, 0, 0), (0),
        A(NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(0, 0, 0, 0), 0, 0, 0L,
        M2_ORC | M2_STRONG | M2_GREEDY | M2_JEWELS, 
        M3_INFRAVISION | M3_INFRAVISIBLE, 0, 0),
    ...
    MON("vampiric", S_VAMPIRE, LVL(0, 2, -3, 0, -3), (0),
        A(NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, 
