...
const struct Role roles[NUM_ROLES+1] = {
    ...
    { { "Healer", 0, 0 },
      { { "Rhizotomist", 0, 0 },
        ...
        { "Embalmer", 0, 0 },
        { "Dresser", 0, 0 },
        { "Medicus ossium", "Medica ossium", "Medicum ossium" },
        { "Herbalist", 0, 0 },
        { "Magister", "Magistra", "Magistrum" }, /* latin, alt "magisterium" */
        { "Physician", 0, 0 },
        { "Chirurgeon", 0, 0 } },
    ...
    {  {"Pirate", 0, 0}, {
        ...
        {"First Mate",      0, 0},
        {"Captain",         0, 0},
        {"Pirate Lord",     "Pirate Lady", "Pirate Noble" },
        {"Dread Pirate",    0, 0} },
    ...
    { { "Tourist", 0, 0 },
      { { "Rambler", 0, 0 },
        { "Sightseer", 0, 0 },
        { "Excursionist", 0, 0 },
        { "Peregrinatus", "Peregrinata", "Peregrinatum" },
        { "Traveler", 0, 0 },
        { "Journeyer", 0, 0 },
        { "Voyager", 0, 0 },
        { "Explorer", 0, 0 },
