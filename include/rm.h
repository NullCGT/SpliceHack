...
#define IS_TREE(typ)                                            \
    ((typ) == TREE || (typ) == DEAD_TREE || (g.level.flags.arboreal && (typ) == STONE))
...
enum screen_symbols {
    ...
    S_vodbridge = 44,
    S_hodbridge = 45,
    S_vcdbridge = 46, /* closed drawbridge, vertical wall */
    S_hcdbridge = 47, /* closed drawbridge, horizontal wall */
    S_air       = 48,
    S_cloud     = 49,
    S_water     = 50,
...
/* end dungeon characters, begin traps */
    ...
    S_hole                 = 66,
    S_trap_door            = 67,
    S_teleportation_trap   = 68,
    S_level_teleporter     = 69,
    S_magic_portal         = 70,
    S_web                  = 71,
    S_statue_trap          = 72,
    S_magic_trap           = 73,
    S_anti_magic_trap      = 74,
    S_polymorph_trap       = 75,
...
struct levelflags {
    ...
    int celltyp;      /* terrain generated by post-gen passes */
