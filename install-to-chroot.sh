...
NHSUBDIR="nh370.32-hdf"
# VAR_PLAYGROUND from include/unixconf.h
NH_VAR_PLAYGROUND="/nh370.32-hdf/var/"
...
mkdir -p "$NAO_CHROOT/dgldir/inprogress-nh370.32-hdf"
chown "$USRGRP" "$NAO_CHROOT/dgldir/inprogress-nh370.32-hdf"
