...
const struct Role roles[NUM_ROLES+1] = {
    ...
    { { "Dragon Rider", 0, 0 },
      ...
      S_QUADRUPED,
      ART_SHARUR,
      ROLE_MALE | ROLE_FEMALE | ROLE_NEUTER | ROLE_LAWFUL | ROLE_NEUTRAL | ROLE_CHAOTIC | MH_HUMAN | MH_ELF,
      /* Str Int Wis Dex Con Cha */
      { 13, 17, 14, 8, 8, 8 },
      { 30, 15, 15, 10, 20, 10 },
      /* Init   Lower  Higher */
...
const struct Race races[] = {
    ...
    },
    {
        ...
        PM_DWARF_MUMMY,
        PM_DWARF_ZOMBIE,
        MH_DWARF | ROLE_MALE | ROLE_FEMALE | ROLE_NEUTER | ROLE_LAWFUL | ROLE_CHAOTIC,
        MH_DWARF,
        MH_DWARF | MH_GNOME,
        MH_ORC,
        /*    Str     Int Wis Dex Con Cha */
    ...
    },
    {
        ...
        PM_GNOME_MUMMY,
        PM_GNOME_ZOMBIE,
        MH_GNOME | ROLE_MALE | ROLE_FEMALE | ROLE_NEUTER | ROLE_NEUTRAL | ROLE_CHAOTIC,
        MH_GNOME,
        MH_DWARF | MH_GNOME,
        MH_HUMAN,
        /*  Str    Int Wis Dex Con Cha */
